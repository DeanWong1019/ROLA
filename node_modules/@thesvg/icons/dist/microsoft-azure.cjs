...
exports.slug = "microsoft-azure";
exports.title = "Microsoft Azure";
exports.hex = "fff";
exports.categories = ["Software", "Microsoft"];
exports.aliases = [];
exports.svg = `<svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
exports.license = "MIT";
exports.url = "https://azure.microsoft.com/";

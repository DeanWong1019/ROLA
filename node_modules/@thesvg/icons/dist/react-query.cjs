...
exports.slug = "react-query";
exports.title = "React Query";
exports.hex = "FF4154";
exports.categories = ["Framework", "Software"];
exports.aliases = [];
exports.svg = `<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 230">
...
exports.url = "https://tanstack.com/query/v4";

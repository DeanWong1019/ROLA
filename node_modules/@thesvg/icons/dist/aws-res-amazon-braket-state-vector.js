// @thesvg/icons - Amazon Braket State Vector
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-braket-state-vector";
export const title = "Amazon Braket State Vector";
export const hex = "ED7100";
export const categories = ["Quantum"];
export const aliases = ["State Vector"];
...
const aws_res_amazon_braket_state_vector = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_braket_state_vector;

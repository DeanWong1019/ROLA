// @thesvg/icons - Amazon RDS Multi AZ
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-rds-multi-az";
export const title = "Amazon RDS Multi AZ";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Multi AZ"];
...
const aws_res_amazon_rds_multi_az = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_rds_multi_az;

// @thesvg/icons - AWS IoT SiteWise Asset Model
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-sitewise-asset-model";
export const title = "AWS IoT SiteWise Asset Model";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Asset Model"];
...
const aws_res_aws_iot_sitewise_asset_model = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_sitewise_asset_model;

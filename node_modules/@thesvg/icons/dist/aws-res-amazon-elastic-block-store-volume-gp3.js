// @thesvg/icons - Amazon Elastic Block Store Volume gp3
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-block-store-volume-gp3";
export const title = "Amazon Elastic Block Store Volume gp3";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Volume gp3"];
...
const aws_res_amazon_elastic_block_store_volume_gp3 = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_block_store_volume_gp3;

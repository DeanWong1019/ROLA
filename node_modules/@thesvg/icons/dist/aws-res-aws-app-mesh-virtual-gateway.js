// @thesvg/icons - AWS App Mesh Virtual Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-app-mesh-virtual-gateway";
export const title = "AWS App Mesh Virtual Gateway";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Virtual Gateway"];
...
const aws_res_aws_app_mesh_virtual_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_app_mesh_virtual_gateway;

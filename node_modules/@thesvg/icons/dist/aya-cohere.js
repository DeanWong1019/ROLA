// @thesvg/icons - Aya (Cohere)
// Auto-generated. Do not edit.

export const slug = "aya-cohere";
export const title = "Aya (Cohere)";
export const hex = "416FDC";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>Aya (Cohere)</title>
...
export const url = "https://cohere.com/research/aya";

const aya_cohere = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aya_cohere;

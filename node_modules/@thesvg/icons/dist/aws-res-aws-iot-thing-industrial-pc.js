// @thesvg/icons - AWS IoT Thing_Industrial PC
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-industrial-pc";
export const title = "AWS IoT Thing_Industrial PC";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Industrial PC"];
...
const aws_res_aws_iot_thing_industrial_pc = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_industrial_pc;

// @thesvg/icons - Amazon Redshift RA3
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-redshift-ra3";
export const title = "Amazon Redshift RA3";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["RA3"];
...
const aws_res_amazon_redshift_ra3 = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_redshift_ra3;

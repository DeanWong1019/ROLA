// @thesvg/icons - AWS IoT Alexa_Enabled Device
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-alexa-enabled-device";
export const title = "AWS IoT Alexa_Enabled Device";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Alexa_Enabled Device"];
...
const aws_res_aws_iot_alexa_enabled_device = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_alexa_enabled_device;

// @thesvg/icons - Amazon DynamoDB Global secondary index
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-global-secondary-index";
export const title = "Amazon DynamoDB Global secondary index";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Global secondary index"];
...
const aws_res_amazon_dynamodb_global_secondary_index = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_global_secondary_index;

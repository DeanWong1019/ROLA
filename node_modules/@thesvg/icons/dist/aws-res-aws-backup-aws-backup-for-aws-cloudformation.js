// @thesvg/icons - AWS Backup AWS Backup for AWS CloudFormation
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-aws-backup-for-aws-cloudformation";
export const title = "AWS Backup AWS Backup for AWS CloudFormation";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["AWS Backup for AWS CloudFormation"];
...
const aws_res_aws_backup_aws_backup_for_aws_cloudformation = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_aws_backup_for_aws_cloudformation;

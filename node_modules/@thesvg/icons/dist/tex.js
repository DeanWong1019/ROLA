...
export const slug = "tex";
export const title = "Tex";
...
const tex = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default tex;

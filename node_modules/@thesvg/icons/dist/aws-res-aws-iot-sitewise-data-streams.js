// @thesvg/icons - AWS IoT SiteWise Data Streams
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-sitewise-data-streams";
export const title = "AWS IoT SiteWise Data Streams";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Data Streams"];
...
const aws_res_aws_iot_sitewise_data_streams = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_sitewise_data_streams;

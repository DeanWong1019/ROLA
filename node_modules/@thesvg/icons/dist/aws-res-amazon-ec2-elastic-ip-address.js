// @thesvg/icons - Amazon EC2 Elastic IP Address
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-ec2-elastic-ip-address";
export const title = "Amazon EC2 Elastic IP Address";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["Elastic IP Address"];
...
const aws_res_amazon_ec2_elastic_ip_address = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_ec2_elastic_ip_address;

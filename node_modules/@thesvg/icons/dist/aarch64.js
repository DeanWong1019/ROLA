// @thesvg/icons - Aarch64
// Auto-generated. Do not edit.

export const slug = "aarch64";
export const title = "Aarch64";
export const hex = "16358C";
export const categories = ["Language"];
export const aliases = ["Arm64"];
...
export const variants = {
  ...
  "line": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
   <path
...
const aarch64 = { slug, title, hex, categories, aliases, svg, variants, license, url };

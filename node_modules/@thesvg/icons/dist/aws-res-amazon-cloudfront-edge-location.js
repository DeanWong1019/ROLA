// @thesvg/icons - Amazon CloudFront Edge Location
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudfront-edge-location";
export const title = "Amazon CloudFront Edge Location";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Edge Location"];
...
const aws_res_amazon_cloudfront_edge_location = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudfront_edge_location;

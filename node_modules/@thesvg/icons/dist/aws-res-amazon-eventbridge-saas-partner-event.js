// @thesvg/icons - Amazon EventBridge Saas Partner Event
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-eventbridge-saas-partner-event";
export const title = "Amazon EventBridge Saas Partner Event";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Saas Partner Event"];
...
const aws_res_amazon_eventbridge_saas_partner_event = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_eventbridge_saas_partner_event;

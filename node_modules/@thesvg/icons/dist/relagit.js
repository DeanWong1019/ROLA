// @thesvg/icons - RelaGit
// Auto-generated. Do not edit.

export const slug = "relagit";
export const title = "RelaGit";
export const hex = "000000";
export const categories = ["Software", "Platform"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="214" height="254" fill="none" viewBox="0 0 214 254">
...
export const variants = {
  "default": `<svg xmlns="http://www.w3.org/2000/svg" width="214" height="254" fill="none" viewBox="0 0 214 254">
<mask id="a" width="214" height="254" x="0" y="0" maskUnits="userSpaceOnUse" style="mask-type:luminance">
<path fill="#fff" d="M0 .5h214v253H0V.5Z"/>
</mask>
<g mask="url(#a)">
...
<path fill="#fff" fill-rule="evenodd" d="M113.631 193.786c-9.102-7.888-19.154-22.171-19.631-38.866l38-.5c.023.796.346 5.316 6.525 10.671 4.962 4.3 11.089 8.268 18.779 13.248 2.208 1.43 4.544 2.943 7.019 4.572C183.619 195.609 213 216.211 213 253.5h-38c0-14.684-10.619-25.078-31.573-38.867-1.738-1.143-3.581-2.333-5.488-3.565-8.001-5.166-17.125-11.057-24.308-17.282Z" clip-rule="evenodd" opacity=".6"/>
  ...
  "light": `<svg xmlns="http://www.w3.org/2000/svg" width="214" height="254" fill="none" viewBox="0 0 214 254">
<mask id="a" width="214" height="254" x="0" y="0" maskUnits="userSpaceOnUse" style="mask-type:luminance">
<path fill="#fff" d="M0 .5h214v253H0V.5Z"/>
</mask>
<g mask="url(#a)">
...
<path fill="#000" fill-rule="evenodd" d="M113.631 193.786c-9.102-7.888-19.154-22.171-19.631-38.866l38-.5c.023.796.346 5.316 6.525 10.671 4.962 4.3 11.089 8.268 18.779 13.248 2.208 1.43 4.544 2.943 7.019 4.572C183.619 195.609 213 216.211 213 253.5h-38c0-14.684-10.619-25.078-31.573-38.867-1.738-1.143-3.581-2.333-5.488-3.565-8.001-5.166-17.125-11.057-24.308-17.282Z" clip-rule="evenodd" opacity=".6"/>
  ...
  "dark": `<svg xmlns="http://www.w3.org/2000/svg" width="214" height="254" fill="none" viewBox="0 0 214 254">
<mask id="a" width="214" height="254" x="0" y="0" maskUnits="userSpaceOnUse" style="mask-type:luminance">
<path fill="#fff" d="M0 .5h214v253H0V.5Z"/>
</mask>
<g mask="url(#a)">
...
<path fill="#fff" fill-rule="evenodd" d="M113.631 193.786c-9.102-7.888-19.154-22.171-19.631-38.866l38-.5c.023.796.346 5.316 6.525 10.671 4.962 4.3 11.089 8.268 18.779 13.248 2.208 1.43 4.544 2.943 7.019 4.572C183.619 195.609 213 216.211 213 253.5h-38c0-14.684-10.619-25.078-31.573-38.867-1.738-1.143-3.581-2.333-5.488-3.565-8.001-5.166-17.125-11.057-24.308-17.282Z" clip-rule="evenodd" opacity=".6"/>
  ...
  "wordmark": `<svg xmlns="http://www.w3.org/2000/svg" width="1959" height="512" fill="none" viewBox="0 0 1959 512">
...
export const url = "https://rela.dev";

const relagit = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default relagit;

// @thesvg/icons - Amazon VPC NAT Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-nat-gateway";
export const title = "Amazon VPC NAT Gateway";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["NAT Gateway"];
...
const aws_res_amazon_vpc_nat_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_nat_gateway;

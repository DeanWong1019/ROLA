// @thesvg/icons - Amazon Route 53 Resolver Query Logging
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-route-53-resolver-query-logging";
export const title = "Amazon Route 53 Resolver Query Logging";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Resolver Query Logging"];
...
const aws_res_amazon_route_53_resolver_query_logging = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_route_53_resolver_query_logging;

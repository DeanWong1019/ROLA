// @thesvg/icons - Amazon Elastic Container Service CopiIoT CLI
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-container-service-copiiot-cli";
export const title = "Amazon Elastic Container Service CopiIoT CLI";
export const hex = "ED7100";
export const categories = ["Containers"];
export const aliases = ["CopiIoT CLI"];
...
const aws_res_amazon_elastic_container_service_copiiot_cli = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_container_service_copiiot_cli;

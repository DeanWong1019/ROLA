// @thesvg/icons - Amazon Aurora Trusted Language Extensions for PostgreSQL
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-aurora-trusted-language-extensions-for-postgresql";
export const title = "Amazon Aurora Trusted Language Extensions for PostgreSQL";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Trusted Language Extensions for PostgreSQL"];
...
const aws_res_amazon_aurora_trusted_language_extensions_for_postgresql = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_aurora_trusted_language_extensions_for_postgresql;

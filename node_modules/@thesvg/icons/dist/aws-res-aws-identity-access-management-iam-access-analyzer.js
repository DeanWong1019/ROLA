// @thesvg/icons - AWS Identity Access Management IAM Access Analyzer
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-iam-access-analyzer";
export const title = "AWS Identity Access Management IAM Access Analyzer";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["IAM Access Analyzer"];
...
const aws_res_aws_identity_access_management_iam_access_analyzer = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_iam_access_analyzer;

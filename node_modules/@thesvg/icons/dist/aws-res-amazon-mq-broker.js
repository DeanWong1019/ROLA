// @thesvg/icons - Amazon MQ Broker
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-mq-broker";
export const title = "Amazon MQ Broker";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Broker"];
...
const aws_res_amazon_mq_broker = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_mq_broker;

...
exports.slug = "aws-res-aws-iot-greengrass-interprocess-communication";
exports.title = "AWS IoT Greengrass Interprocess Communication";
exports.hex = "232F3E";
exports.categories = ["IoT"];
exports.aliases = ["Interprocess Communication"];

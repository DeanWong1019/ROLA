// @thesvg/icons - AWS IoT Thing_Lightbulb
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-lightbulb";
export const title = "AWS IoT Thing_Lightbulb";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Lightbulb"];
...
const aws_res_aws_iot_thing_lightbulb = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_lightbulb;

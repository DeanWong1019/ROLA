// @thesvg/icons - AWS Systems Manager Change Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-change-manager";
export const title = "AWS Systems Manager Change Manager";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Change Manager"];
...
const aws_res_aws_systems_manager_change_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_change_manager;

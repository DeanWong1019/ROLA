// @thesvg/icons - AWS Identity Access Management MFA Token
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-mfa-token";
export const title = "AWS Identity Access Management MFA Token";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["MFA Token"];
...
const aws_res_aws_identity_access_management_mfa_token = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_mfa_token;

...
exports.slug = "aws-res-amazon-dynamodb-standard-access-table-class";
exports.title = "Amazon DynamoDB Standard Access Table Class";
exports.hex = "527FFF";
exports.categories = ["Database"];
exports.aliases = ["Standard Access Table Class"];

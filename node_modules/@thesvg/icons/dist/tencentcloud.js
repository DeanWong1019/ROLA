// @thesvg/icons - TencentCloud (腾讯云)
// Auto-generated. Do not edit.

export const slug = "tencentcloud";
export const title = "TencentCloud (腾讯云)";
export const hex = "2151d1";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>TencentCloud (腾讯云)</title>
...
export const url = "https://cloud.tencent.com";

const tencentcloud = { slug, title, hex, categories, aliases, svg, variants, license, url };

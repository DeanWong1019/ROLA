// @thesvg/icons - AWS IoT Device Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-device-gateway";
export const title = "AWS IoT Device Gateway";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Device Gateway"];
...
const aws_res_aws_iot_device_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_device_gateway;

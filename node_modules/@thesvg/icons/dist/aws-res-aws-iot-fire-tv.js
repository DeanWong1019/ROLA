// @thesvg/icons - AWS IoT Fire_TV
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-fire-tv";
export const title = "AWS IoT Fire_TV";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Fire_TV"];
...
const aws_res_aws_iot_fire_tv = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_fire_tv;

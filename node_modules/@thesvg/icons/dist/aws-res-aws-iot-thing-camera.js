// @thesvg/icons - AWS IoT Thing_Camera
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-camera";
export const title = "AWS IoT Thing_Camera";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Camera"];
...
const aws_res_aws_iot_thing_camera = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_camera;

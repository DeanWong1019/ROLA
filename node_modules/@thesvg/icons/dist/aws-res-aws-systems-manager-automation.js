// @thesvg/icons - AWS Systems Manager Automation
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-automation";
export const title = "AWS Systems Manager Automation";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Automation"];
...
const aws_res_aws_systems_manager_automation = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_automation;

// @thesvg/icons - AWS Directory Service Simple AD
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-directory-service-simple-ad";
export const title = "AWS Directory Service Simple AD";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Simple AD"];
...
const aws_res_aws_directory_service_simple_ad = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_directory_service_simple_ad;

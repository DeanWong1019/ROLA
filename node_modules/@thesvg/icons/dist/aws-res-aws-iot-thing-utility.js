// @thesvg/icons - AWS IoT Thing_Utility
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-utility";
export const title = "AWS IoT Thing_Utility";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Utility"];
...
const aws_res_aws_iot_thing_utility = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_utility;

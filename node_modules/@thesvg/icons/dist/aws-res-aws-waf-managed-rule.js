// @thesvg/icons - AWS WAF Managed Rule
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-waf-managed-rule";
export const title = "AWS WAF Managed Rule";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Managed Rule"];
...
const aws_res_aws_waf_managed_rule = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_waf_managed_rule;

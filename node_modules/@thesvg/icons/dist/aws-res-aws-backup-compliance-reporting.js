// @thesvg/icons - AWS Backup Compliance Reporting
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-compliance-reporting";
export const title = "AWS Backup Compliance Reporting";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Compliance Reporting"];
...
const aws_res_aws_backup_compliance_reporting = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_compliance_reporting;

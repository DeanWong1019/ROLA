// @thesvg/icons - AWS App Mesh Mesh
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-app-mesh-mesh";
export const title = "AWS App Mesh Mesh";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Mesh"];
...
const aws_res_aws_app_mesh_mesh = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_app_mesh_mesh;

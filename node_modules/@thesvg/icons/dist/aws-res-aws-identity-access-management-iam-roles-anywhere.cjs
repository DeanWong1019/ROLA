...
exports.slug = "aws-res-aws-identity-access-management-iam-roles-anywhere";
exports.title = "AWS Identity Access Management IAM Roles Anywhere";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["IAM Roles Anywhere"];

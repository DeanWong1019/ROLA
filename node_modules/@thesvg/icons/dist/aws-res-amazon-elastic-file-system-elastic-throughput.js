// @thesvg/icons - Amazon Elastic File System Elastic Throughput
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-file-system-elastic-throughput";
export const title = "Amazon Elastic File System Elastic Throughput";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Elastic Throughput"];
...
const aws_res_amazon_elastic_file_system_elastic_throughput = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_file_system_elastic_throughput;

// @thesvg/icons - Amazon Redshift Streaming Ingestion
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-redshift-streaming-ingestion";
export const title = "Amazon Redshift Streaming Ingestion";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Streaming Ingestion"];
...
const aws_res_amazon_redshift_streaming_ingestion = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_redshift_streaming_ingestion;

// @thesvg/icons - AWS Systems Manager Change Calendar
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-change-calendar";
export const title = "AWS Systems Manager Change Calendar";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Change Calendar"];
...
const aws_res_aws_systems_manager_change_calendar = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_change_calendar;

// @thesvg/icons - AWS WAF Labels
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-waf-labels";
export const title = "AWS WAF Labels";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Labels"];
...
const aws_res_aws_waf_labels = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_waf_labels;

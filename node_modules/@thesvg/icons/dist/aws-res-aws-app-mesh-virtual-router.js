// @thesvg/icons - AWS App Mesh Virtual Router
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-app-mesh-virtual-router";
export const title = "AWS App Mesh Virtual Router";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Virtual Router"];
...
const aws_res_aws_app_mesh_virtual_router = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_app_mesh_virtual_router;

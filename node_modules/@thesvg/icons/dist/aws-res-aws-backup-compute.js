// @thesvg/icons - AWS Backup Compute
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-compute";
export const title = "AWS Backup Compute";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Compute"];
...
const aws_res_aws_backup_compute = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_compute;

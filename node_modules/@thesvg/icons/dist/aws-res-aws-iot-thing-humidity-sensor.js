// @thesvg/icons - AWS IoT Thing_Humidity Sensor
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-humidity-sensor";
export const title = "AWS IoT Thing_Humidity Sensor";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Humidity Sensor"];
...
const aws_res_aws_iot_thing_humidity_sensor = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_humidity_sensor;

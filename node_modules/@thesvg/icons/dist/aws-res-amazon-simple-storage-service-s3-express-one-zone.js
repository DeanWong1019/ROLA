// @thesvg/icons - Amazon Simple Storage Service S3 Express One Zone
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-s3-express-one-zone";
export const title = "Amazon Simple Storage Service S3 Express One Zone";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["S3 Express One Zone"];
...
const aws_res_amazon_simple_storage_service_s3_express_one_zone = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_s3_express_one_zone;

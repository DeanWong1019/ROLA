// @thesvg/icons - AWS Cloud Map Namespace
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloud-map-namespace";
export const title = "AWS Cloud Map Namespace";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Namespace"];
...
const aws_res_aws_cloud_map_namespace = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloud_map_namespace;

...
exports.slug = "aws-res-aws-storage-gateway-virtual-tape-library";
exports.title = "AWS Storage Gateway Virtual Tape Library";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["Virtual Tape Library"];

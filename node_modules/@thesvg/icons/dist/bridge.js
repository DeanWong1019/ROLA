...
export const slug = "bridge";
export const title = "Bridge";
...
export const url = "https://www.adobe.com/products/bridge";

const bridge = { slug, title, hex, categories, aliases, svg, variants, license, url };

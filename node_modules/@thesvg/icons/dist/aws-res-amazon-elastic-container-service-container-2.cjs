...
exports.slug = "aws-res-amazon-elastic-container-service-container-2";
exports.title = "Amazon Elastic Container Service Container 2";
exports.hex = "ED7100";
exports.categories = ["Containers"];
exports.aliases = ["Container 2"];

// @thesvg/icons - AWS Systems Manager Documents
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-documents";
export const title = "AWS Systems Manager Documents";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Documents"];
...
const aws_res_aws_systems_manager_documents = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_documents;

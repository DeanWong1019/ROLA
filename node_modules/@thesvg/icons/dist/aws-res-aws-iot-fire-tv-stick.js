// @thesvg/icons - AWS IoT Fire TV_Stick
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-fire-tv-stick";
export const title = "AWS IoT Fire TV_Stick";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Fire TV_Stick"];
...
const aws_res_aws_iot_fire_tv_stick = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_fire_tv_stick;

// @thesvg/icons - Amazon EventBridge Schema Registry
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-eventbridge-schema-registry";
export const title = "Amazon EventBridge Schema Registry";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Schema Registry"];
...
const aws_res_amazon_eventbridge_schema_registry = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_eventbridge_schema_registry;

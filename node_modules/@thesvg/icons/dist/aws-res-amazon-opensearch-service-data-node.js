// @thesvg/icons - Amazon OpenSearch Service Data Node
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-opensearch-service-data-node";
export const title = "Amazon OpenSearch Service Data Node";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Data Node"];
...
const aws_res_amazon_opensearch_service_data_node = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_opensearch_service_data_node;

// @thesvg/icons - AWS Organizations Management Account
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-organizations-management-account";
export const title = "AWS Organizations Management Account";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Management Account"];
...
const aws_res_aws_organizations_management_account = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_organizations_management_account;

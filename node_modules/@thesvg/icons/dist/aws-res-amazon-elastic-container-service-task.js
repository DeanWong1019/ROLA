// @thesvg/icons - Amazon Elastic Container Service Task
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-container-service-task";
export const title = "Amazon Elastic Container Service Task";
export const hex = "ED7100";
export const categories = ["Containers"];
export const aliases = ["Task"];
...
const aws_res_amazon_elastic_container_service_task = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_container_service_task;

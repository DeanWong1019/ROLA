// @thesvg/icons - Austrian Airlines
// Auto-generated. Do not edit.

export const slug = "austrian-airlines";
export const title = "Austrian Airlines";
export const hex = "E20A16";
export const categories = ["Aviation"];
export const aliases = ["AUA"];
export const svg = `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 499.3 72" style="enable-background:new 0 0 499.3 72;" xml:space="preserve">
 <style type="text/css">
...
export const variants = {
  "default": `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 499.3 72" style="enable-background:new 0 0 499.3 72;" xml:space="preserve">
 <style type="text/css">
  .st0{fill-rule:evenodd;clip-rule:evenodd;fill:#D81E05;}
	.st1{fill:none;}
	.st2{fill-rule:evenodd;clip-rule:evenodd;fill:#93282C;}
 ...
 <g>
  ...
  "mono": `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 124.4 64" style="enable-background:new 0 0 124.4 64;" xml:space="preserve">
 <style type="text/css">
  .st0{fill-rule:evenodd;clip-rule:evenodd;fill:#D81E05;}
	.st1{fill-rule:evenodd;clip-rule:evenodd;fill:#93282C;}
 </style>
 <g>
  <path class="st0" d="M13.6,53c16.5-13.3,28.2-24.8,31.7-31c1.5-2.4,2-4.7,1.1-6.5c-1.5-3.5-7-4.5-13.6-3.2
		...
		c-0.3,0-0.4-0.3-0.2-0.5C4.7,60.1,9.2,56.6,13.6,53">
  </path>
  <path class="st1" d="M11,17.4c-0.4,0.1-0.9,0.2-1.3,0.4c-0.3,0.1-0.2,0.4,0,0.5l7.4,1.1L30,21.2c0.1,0,0.1,0,0.1,0
		c9.1-4.3,15.1-6,16.5-4.1c0.4,0.6,0.3,1.5-0.1,2.6c-0.2,0.4-0.4,0.8-0.6,1.3c1.4-2.3,1.9-4.4,1.1-6.2c-1.5-3.3-6.6-4.3-13.1-3
		C26.2,13.5,18.6,15.4,11,17.4">
  </path>
 </g>
</svg>`
};
export const license = "Fair Use";
export const url = "https://www.austrian.com";

const austrian_airlines = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default austrian_airlines;

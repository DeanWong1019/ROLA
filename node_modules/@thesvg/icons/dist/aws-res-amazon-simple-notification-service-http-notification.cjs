...
exports.slug = "aws-res-amazon-simple-notification-service-http-notification";
exports.title = "Amazon Simple Notification Service HTTP Notification";
exports.hex = "E7157B";
exports.categories = ["Integration"];
exports.aliases = ["HTTP Notification"];

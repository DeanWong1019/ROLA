...
exports.slug = "aws-res-aws-backup-aws-backup-support-for-vmware-workloads";
exports.title = "AWS Backup AWS Backup Support for VMware Workloads";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["AWS Backup Support for VMware Workloads"];

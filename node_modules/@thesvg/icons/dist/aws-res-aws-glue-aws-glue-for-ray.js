// @thesvg/icons - AWS Glue AWS Glue for Ray
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-glue-aws-glue-for-ray";
export const title = "AWS Glue AWS Glue for Ray";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["AWS Glue for Ray"];
...
const aws_res_aws_glue_aws_glue_for_ray = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_glue_aws_glue_for_ray;

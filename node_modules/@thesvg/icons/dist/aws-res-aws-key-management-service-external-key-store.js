// @thesvg/icons - AWS Key Management Service External Key Store
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-key-management-service-external-key-store";
export const title = "AWS Key Management Service External Key Store";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["External Key Store"];
...
const aws_res_aws_key_management_service_external_key_store = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_key_management_service_external_key_store;

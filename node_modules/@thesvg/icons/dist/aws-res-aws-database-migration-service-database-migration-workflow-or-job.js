// @thesvg/icons - AWS Database Migration Service Database migration workflow or job
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-database-migration-service-database-migration-workflow-or-job";
export const title = "AWS Database Migration Service Database migration workflow or job";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Database migration workflow or job"];
...
const aws_res_aws_database_migration_service_database_migration_workflow_or_job = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_database_migration_service_database_migration_workflow_or_job;

...
exports.slug = "aws-res-aws-certificate-manager-certificate-authority";
exports.title = "AWS Certificate Manager Certificate Authority";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["Certificate Authority"];

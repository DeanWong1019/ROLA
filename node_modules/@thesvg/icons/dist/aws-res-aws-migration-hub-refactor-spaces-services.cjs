...
exports.slug = "aws-res-aws-migration-hub-refactor-spaces-services";
exports.title = "AWS Migration Hub Refactor Spaces Services";
exports.hex = "01A88D";
exports.categories = ["Migration"];
exports.aliases = ["Refactor Spaces Services"];

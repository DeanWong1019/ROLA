// @thesvg/icons - Amazon OpenSearch Service Observability
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-opensearch-service-observability";
export const title = "Amazon OpenSearch Service Observability";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Observability"];
...
const aws_res_amazon_opensearch_service_observability = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_opensearch_service_observability;

// @thesvg/icons - Amazon Athena Data Source Connectors
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-athena-data-source-connectors";
export const title = "Amazon Athena Data Source Connectors";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Data Source Connectors"];
...
const aws_res_amazon_athena_data_source_connectors = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_athena_data_source_connectors;

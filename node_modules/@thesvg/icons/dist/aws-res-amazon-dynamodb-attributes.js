// @thesvg/icons - Amazon DynamoDB Attributes
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-attributes";
export const title = "Amazon DynamoDB Attributes";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Attributes"];
...
const aws_res_amazon_dynamodb_attributes = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_attributes;

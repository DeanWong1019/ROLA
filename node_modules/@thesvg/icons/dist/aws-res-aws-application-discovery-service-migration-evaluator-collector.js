// @thesvg/icons - AWS Application Discovery Service Migration Evaluator Collector
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-application-discovery-service-migration-evaluator-collector";
export const title = "AWS Application Discovery Service Migration Evaluator Collector";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Migration Evaluator Collector"];
...
const aws_res_aws_application_discovery_service_migration_evaluator_collector = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_application_discovery_service_migration_evaluator_collector;

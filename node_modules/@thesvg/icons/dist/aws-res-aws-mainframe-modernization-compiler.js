// @thesvg/icons - AWS Mainframe Modernization Compiler
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-mainframe-modernization-compiler";
export const title = "AWS Mainframe Modernization Compiler";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Compiler"];
...
const aws_res_aws_mainframe_modernization_compiler = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_mainframe_modernization_compiler;

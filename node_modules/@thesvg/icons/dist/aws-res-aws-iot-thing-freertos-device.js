// @thesvg/icons - AWS IoT Thing_FreeRTOS Device
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-freertos-device";
export const title = "AWS IoT Thing_FreeRTOS Device";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_FreeRTOS Device"];
...
const aws_res_aws_iot_thing_freertos_device = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_freertos_device;

// @thesvg/icons - AWS IoT Greengrass Interprocess Communication
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-greengrass-interprocess-communication";
export const title = "AWS IoT Greengrass Interprocess Communication";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Interprocess Communication"];
...
const aws_res_aws_iot_greengrass_interprocess_communication = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_greengrass_interprocess_communication;

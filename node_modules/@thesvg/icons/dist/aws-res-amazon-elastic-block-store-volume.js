// @thesvg/icons - Amazon Elastic Block Store Volume
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-block-store-volume";
export const title = "Amazon Elastic Block Store Volume";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Volume"];
...
const aws_res_amazon_elastic_block_store_volume = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_block_store_volume;

// @thesvg/icons - AWS IoT Thing_Windfarm
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-windfarm";
export const title = "AWS IoT Thing_Windfarm";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Windfarm"];
...
const aws_res_aws_iot_thing_windfarm = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_windfarm;

// @thesvg/icons - AWS Identity Access Management Permissions
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-permissions";
export const title = "AWS Identity Access Management Permissions";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Permissions"];
...
const aws_res_aws_identity_access_management_permissions = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_permissions;

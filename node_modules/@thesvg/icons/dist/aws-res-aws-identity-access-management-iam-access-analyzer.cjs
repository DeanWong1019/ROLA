...
exports.slug = "aws-res-aws-identity-access-management-iam-access-analyzer";
exports.title = "AWS Identity Access Management IAM Access Analyzer";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["IAM Access Analyzer"];

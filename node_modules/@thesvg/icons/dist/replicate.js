// @thesvg/icons - Replicate
// Auto-generated. Do not edit.

export const slug = "replicate";
export const title = "Replicate";
export const hex = "EA2805";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg width="726" height="726" viewBox="0 0 726 726" fill="#ffff" xmlns="http://www.w3.org/2000/svg">
...
export const variants = {
  "default": `<svg width="726" height="726" viewBox="0 0 726 726" fill="#ffff" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_1_3)">
<path d="M726 310.438V392.476H438.068V726H346.302V310.438H726Z" fill="#ffff"/>
<path d="M726 155.219V237.402H264.845V726H173.078V155.219H726Z" fill="#ffff"/>
<path d="M726 0V82.1832H91.7664V726H0V0H726Z" fill="#ffff"/>
...
<rect width="726" height="726" fill="#ffff"/>
  ...
  "mono": `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Replicate</title><path d="M24 10.262v2.712h-9.518V24h-3.034V10.262zm0-5.131v2.717H8.755V24H5.722V5.131zM24 0v2.717H3.034V24H0V0z"/></svg>`,
  "light": `<svg width="726" height="726" viewBox="0 0 726 726" fill="#000" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_1_3)">
...
<rect width="726" height="726" fill="#000"/>
  ...
  "dark": `<svg width="726" height="726" viewBox="0 0 726 726" fill="#ffff" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_1_3)">
<path d="M726 310.438V392.476H438.068V726H346.302V310.438H726Z" fill="#ffff"/>
<path d="M726 155.219V237.402H264.845V726H173.078V155.219H726Z" fill="#ffff"/>
<path d="M726 0V82.1832H91.7664V726H0V0H726Z" fill="#ffff"/>
...
<rect width="726" height="726" fill="#ffff"/>
  ...
  "wordmark": `<svg width="831" height="192" viewBox="0 0 831 192" fill="#ffff" xmlns="http://www.w3.org/2000/svg">
...
export const url = "https://replicate.com/";

const replicate = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - Capital One
// Auto-generated. Do not edit.

export const slug = "capital-one";
export const title = "Capital One";
export const hex = "004977";
export const categories = ["Finance", "Software"];
export const aliases = ["CapitalOne"];
...
export const url = "https://www.capitalone.com";

const capital_one = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default capital_one;

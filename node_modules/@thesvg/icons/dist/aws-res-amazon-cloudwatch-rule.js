// @thesvg/icons - Amazon CloudWatch Rule
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-rule";
export const title = "Amazon CloudWatch Rule";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Rule"];
...
const aws_res_amazon_cloudwatch_rule = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_rule;

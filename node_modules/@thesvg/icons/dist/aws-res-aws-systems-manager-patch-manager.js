// @thesvg/icons - AWS Systems Manager Patch Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-patch-manager";
export const title = "AWS Systems Manager Patch Manager";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Patch Manager"];
...
const aws_res_aws_systems_manager_patch_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_patch_manager;

...
exports.slug = "aws-res-amazon-elastic-block-store-multiple-volumes";
exports.title = "Amazon Elastic Block Store Multiple Volumes";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["Multiple Volumes"];

// @thesvg/icons - AWS Glue Data Catalog
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-glue-data-catalog";
export const title = "AWS Glue Data Catalog";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Data Catalog"];
...
const aws_res_aws_glue_data_catalog = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_glue_data_catalog;

// @thesvg/icons - AT Protocol
// Auto-generated. Do not edit.

export const slug = "atproto";
export const title = "AT Protocol";
export const hex = "0085FF";
export const categories = ["Social", "Software"];
...
export const url = "https://atproto.com";

const atproto = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - Amazon VPC VPN Connection
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-vpn-connection";
export const title = "Amazon VPC VPN Connection";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["VPN Connection"];
...
const aws_res_amazon_vpc_vpn_connection = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_vpn_connection;

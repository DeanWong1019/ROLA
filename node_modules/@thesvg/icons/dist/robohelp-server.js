// @thesvg/icons - RoboHelp Server
// Auto-generated. Do not edit.

export const slug = "robohelp-server";
export const title = "RoboHelp Server";
export const hex = "002623";
export const categories = ["Software", "DevTool", "Platform"];
...
export const url = "https://www.adobe.com/products/robohelp";

const robohelp_server = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default robohelp_server;

...
export const slug = "nebius";
export const title = "Nebius";
export const hex = "DAFF33";
...
export const url = "https://nebius.com";

const nebius = { slug, title, hex, categories, aliases, svg, variants, license, url };

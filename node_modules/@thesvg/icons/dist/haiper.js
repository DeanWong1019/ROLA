...
export const slug = "haiper";
export const title = "Haiper";
export const hex = "9581ff";
...
export const url = "https://haiper.ai";

const haiper = { slug, title, hex, categories, aliases, svg, variants, license, url };

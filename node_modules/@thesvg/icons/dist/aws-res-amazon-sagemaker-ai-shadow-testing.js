// @thesvg/icons - Amazon SageMaker AI Shadow Testing
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-sagemaker-ai-shadow-testing";
export const title = "Amazon SageMaker AI Shadow Testing";
export const hex = "01A88D";
export const categories = ["AI"];
export const aliases = ["Shadow Testing"];
...
const aws_res_amazon_sagemaker_ai_shadow_testing = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_sagemaker_ai_shadow_testing;

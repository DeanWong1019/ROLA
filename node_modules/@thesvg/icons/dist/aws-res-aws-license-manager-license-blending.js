// @thesvg/icons - AWS License Manager License Blending
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-license-manager-license-blending";
export const title = "AWS License Manager License Blending";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["License Blending"];
...
const aws_res_aws_license_manager_license_blending = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_license_manager_license_blending;

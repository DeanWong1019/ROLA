// @thesvg/icons - Amazon DataZone Business Data Catalog
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-datazone-business-data-catalog";
export const title = "Amazon DataZone Business Data Catalog";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Business Data Catalog"];
...
const aws_res_amazon_datazone_business_data_catalog = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_datazone_business_data_catalog;

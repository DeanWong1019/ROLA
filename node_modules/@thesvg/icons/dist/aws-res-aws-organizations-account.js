// @thesvg/icons - AWS Organizations Account
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-organizations-account";
export const title = "AWS Organizations Account";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Account"];
...
const aws_res_aws_organizations_account = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_organizations_account;

// @thesvg/icons - Amazon EventBridge Pipes
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-eventbridge-pipes";
export const title = "Amazon EventBridge Pipes";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Pipes"];
...
const aws_res_amazon_eventbridge_pipes = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_eventbridge_pipes;

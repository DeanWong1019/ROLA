...
exports.slug = "aws-res-aws-iot-thing-temperature-humidity-sensor";
exports.title = "AWS IoT Thing_Temperature Humidity Sensor";
exports.hex = "232F3E";
exports.categories = ["IoT"];
exports.aliases = ["Thing_Temperature Humidity Sensor"];

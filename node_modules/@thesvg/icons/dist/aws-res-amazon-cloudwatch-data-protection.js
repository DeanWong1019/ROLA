// @thesvg/icons - Amazon CloudWatch Data Protection
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-data-protection";
export const title = "Amazon CloudWatch Data Protection";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Data Protection"];
...
const aws_res_amazon_cloudwatch_data_protection = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_data_protection;

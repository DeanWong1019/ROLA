// @thesvg/icons - StateCloud (天翼云)
// Auto-generated. Do not edit.

export const slug = "statecloud";
export const title = "StateCloud (天翼云)";
export const hex = "DF0428";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>StateCloud (天翼云)</title>
...
export const url = "https://ctyun.cn/act/xirang/deepseek";

const statecloud = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default statecloud;

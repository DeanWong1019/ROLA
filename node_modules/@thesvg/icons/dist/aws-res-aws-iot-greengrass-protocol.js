// @thesvg/icons - AWS IoT Greengrass Protocol
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-greengrass-protocol";
export const title = "AWS IoT Greengrass Protocol";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Protocol"];
...
const aws_res_aws_iot_greengrass_protocol = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_greengrass_protocol;

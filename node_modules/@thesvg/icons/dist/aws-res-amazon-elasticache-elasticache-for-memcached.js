// @thesvg/icons - Amazon ElastiCache ElastiCache for Memcached
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elasticache-elasticache-for-memcached";
export const title = "Amazon ElastiCache ElastiCache for Memcached";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["ElastiCache for Memcached"];
...
const aws_res_amazon_elasticache_elasticache_for_memcached = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elasticache_elasticache_for_memcached;

// @thesvg/icons - React Query
// Auto-generated. Do not edit.

export const slug = "react-query";
export const title = "React Query";
export const hex = "FF4154";
export const categories = ["Framework", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 230">

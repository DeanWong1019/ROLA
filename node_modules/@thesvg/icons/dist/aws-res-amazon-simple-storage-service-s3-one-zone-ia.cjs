...
exports.slug = "aws-res-amazon-simple-storage-service-s3-one-zone-ia";
exports.title = "Amazon Simple Storage Service S3 One Zone IA";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["S3 One Zone IA"];

...
export const slug = "voyage";
export const title = "Voyage";
export const hex = "012E33";
...
export const url = "https://voyageai.com";

const voyage = { slug, title, hex, categories, aliases, svg, variants, license, url };

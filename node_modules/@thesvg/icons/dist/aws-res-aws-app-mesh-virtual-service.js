// @thesvg/icons - AWS App Mesh Virtual Service
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-app-mesh-virtual-service";
export const title = "AWS App Mesh Virtual Service";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Virtual Service"];
...
const aws_res_aws_app_mesh_virtual_service = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_app_mesh_virtual_service;

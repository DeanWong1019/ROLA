// @thesvg/icons - Amazon Simple Storage Service S3 Glacier Flexible Retrieval
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-s3-glacier-flexible-retrieval";
export const title = "Amazon Simple Storage Service S3 Glacier Flexible Retrieval";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["S3 Glacier Flexible Retrieval"];
...
const aws_res_amazon_simple_storage_service_s3_glacier_flexible_retrieval = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_s3_glacier_flexible_retrieval;

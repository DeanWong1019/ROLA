// @thesvg/icons - Amazon Location Service Track 
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-location-service-track";
export const title = "Amazon Location Service Track ";
export const hex = "C7131F";
export const categories = ["Frontend"];
export const aliases = ["Track "];
...
const aws_res_amazon_location_service_track = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_location_service_track;

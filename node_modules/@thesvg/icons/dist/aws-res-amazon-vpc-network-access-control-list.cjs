...
exports.slug = "aws-res-amazon-vpc-network-access-control-list";
exports.title = "Amazon VPC Network Access Control List";
exports.hex = "8C4FFF";
exports.categories = ["Networking"];
exports.aliases = ["Network Access Control List"];

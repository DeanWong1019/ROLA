// @thesvg/icons - Amazon VPC Peering Connection
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-peering-connection";
export const title = "Amazon VPC Peering Connection";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Peering Connection"];
...
const aws_res_amazon_vpc_peering_connection = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_peering_connection;

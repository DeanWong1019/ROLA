...
export const slug = "jest";
export const title = "Jest";
export const hex = "C21325";
export const categories = ["Devtool", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 283">

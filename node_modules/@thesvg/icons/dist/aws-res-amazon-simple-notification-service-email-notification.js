// @thesvg/icons - Amazon Simple Notification Service Email Notification
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-notification-service-email-notification";
export const title = "Amazon Simple Notification Service Email Notification";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Email Notification"];
...
const aws_res_amazon_simple_notification_service_email_notification = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_notification_service_email_notification;

// @thesvg/icons - AWS IoT Sailboat
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-sailboat";
export const title = "AWS IoT Sailboat";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Sailboat"];
...
const aws_res_aws_iot_sailboat = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_sailboat;

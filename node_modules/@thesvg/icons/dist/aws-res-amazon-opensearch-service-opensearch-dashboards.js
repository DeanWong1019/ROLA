// @thesvg/icons - Amazon OpenSearch Service OpenSearch Dashboards
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-opensearch-service-opensearch-dashboards";
export const title = "Amazon OpenSearch Service OpenSearch Dashboards";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["OpenSearch Dashboards"];
...
const aws_res_amazon_opensearch_service_opensearch_dashboards = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_opensearch_service_opensearch_dashboards;

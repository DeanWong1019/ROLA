// @thesvg/icons - AWS IoT Greengrass Recipe
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-greengrass-recipe";
export const title = "AWS IoT Greengrass Recipe";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Recipe"];
...
const aws_res_aws_iot_greengrass_recipe = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_greengrass_recipe;

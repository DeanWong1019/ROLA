// @thesvg/icons - Amazon ElastiCache ElastiCache for Redis
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elasticache-elasticache-for-redis";
export const title = "Amazon ElastiCache ElastiCache for Redis";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["ElastiCache for Redis"];
...
const aws_res_amazon_elasticache_elasticache_for_redis = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elasticache_elasticache_for_redis;

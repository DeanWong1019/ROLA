// @thesvg/icons - AWS Storage Gateway Amazon S3 File Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-storage-gateway-amazon-s3-file-gateway";
export const title = "AWS Storage Gateway Amazon S3 File Gateway";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Amazon S3 File Gateway"];
...
const aws_res_aws_storage_gateway_amazon_s3_file_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_storage_gateway_amazon_s3_file_gateway;

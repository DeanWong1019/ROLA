// @thesvg/icons - Qingyan (智谱清言)
// Auto-generated. Do not edit.

export const slug = "qingyan";
export const title = "Qingyan (智谱清言)";
export const hex = "1041F3";
export const categories = ["Software", "Platform"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>Qingyan (智谱清言)</title>
...
export const url = "https://chatglm.cn";

const qingyan = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default qingyan;

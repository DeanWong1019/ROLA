// @thesvg/icons - Amazon Redshift ML
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-redshift-ml";
export const title = "Amazon Redshift ML";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["ML"];
...
const aws_res_amazon_redshift_ml = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_redshift_ml;

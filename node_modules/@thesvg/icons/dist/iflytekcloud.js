// @thesvg/icons - IFlyTekCloud (讯飞开放平台)
// Auto-generated. Do not edit.

export const slug = "iflytekcloud";
export const title = "IFlyTekCloud (讯飞开放平台)";
export const hex = "2A80E2";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>IFlyTekCloud (讯飞开放平台)</title>
...
export const url = "https://xfyun.cn";

const iflytekcloud = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default iflytekcloud;

...
exports.aliases = [];
exports.svg = `<svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M39 24H24V6H6V24H24V39H0V6H6V0H39V24Z" fill="#81ADEC"/></svg>`;
exports.variants = {
...
exports.license = "MIT";
exports.url = "https://paper.design/";

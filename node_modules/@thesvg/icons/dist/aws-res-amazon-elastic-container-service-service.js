// @thesvg/icons - Amazon Elastic Container Service Service
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-container-service-service";
export const title = "Amazon Elastic Container Service Service";
export const hex = "ED7100";
export const categories = ["Containers"];
export const aliases = ["Service"];
...
const aws_res_amazon_elastic_container_service_service = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_container_service_service;

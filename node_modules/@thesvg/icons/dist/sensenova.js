// @thesvg/icons - SenseNova (商汤)
// Auto-generated. Do not edit.

export const slug = "sensenova";
export const title = "SenseNova (商汤)";
export const hex = "5B2AD8";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>SenseNova (商汤)</title>
...
export const url = "https://platform.sensenova.cn";

const sensenova = { slug, title, hex, categories, aliases, svg, variants, license, url };

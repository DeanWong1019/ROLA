// @thesvg/icons - AWS IoT Core Device Advisor
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-core-device-advisor";
export const title = "AWS IoT Core Device Advisor";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Device Advisor"];
...
const aws_res_aws_iot_core_device_advisor = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_core_device_advisor;

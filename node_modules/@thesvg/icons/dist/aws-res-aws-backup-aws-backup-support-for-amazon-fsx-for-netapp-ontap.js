// @thesvg/icons - AWS Backup AWS Backup support for Amazon FSx for NetApp ONTAP
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-aws-backup-support-for-amazon-fsx-for-netapp-ontap";
export const title = "AWS Backup AWS Backup support for Amazon FSx for NetApp ONTAP";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["AWS Backup support for Amazon FSx for NetApp ONTAP"];
...
const aws_res_aws_backup_aws_backup_support_for_amazon_fsx_for_netapp_ontap = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_aws_backup_support_for_amazon_fsx_for_netapp_ontap;

// @thesvg/icons - Amazon Braket Embedded Simulator
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-braket-embedded-simulator";
export const title = "Amazon Braket Embedded Simulator";
export const hex = "ED7100";
export const categories = ["Quantum"];
export const aliases = ["Embedded Simulator"];
...
const aws_res_amazon_braket_embedded_simulator = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_braket_embedded_simulator;

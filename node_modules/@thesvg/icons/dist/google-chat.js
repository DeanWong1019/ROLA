// @thesvg/icons - Google Chat
// Auto-generated. Do not edit.

export const slug = "google-chat";
export const title = "Google Chat";
export const hex = "34A853";
export const categories = ["Google", "Software"];
export const aliases = [];
export const svg = `<svg role="img" width="96" height="100" viewBox="0 0 311 320" xmlns="http://www.w3.org/2000/svg">
...
export const variants = {
  "default": `<svg role="img" width="96" height="100" viewBox="0 0 311 320" xmlns="http://www.w3.org/2000/svg">
  <title>Google Chat</title>
  <g stroke-width="2" fill="none" stroke-linecap="butt">
    <path stroke="#7e916f" vector-effect="non-scaling-stroke" d="M76.37.51l.01 76.47"/>
    <path stroke="#1375eb" vector-effect="non-scaling-stroke" d="M76.38 76.98 0 76.96"/>
  ...
  "mono": `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Google Chat</title><path d="M1.637 0C.733 0 0 .733 0 1.637v16.5c0 .904.733 1.636 1.637 1.636h3.955v3.323c0 .804.97 1.207 1.539.638l3.963-3.96h11.27c.903 0 1.636-.733 1.636-1.637V5.592L18.408 0Zm3.955 5.592h12.816v8.59H8.455l-2.863 2.863Z"/></svg>`
};
export const license = "CC0-1.0";
export const url = "https://chat.google.com/";

const google_chat = { slug, title, hex, categories, aliases, svg, variants, license, url };

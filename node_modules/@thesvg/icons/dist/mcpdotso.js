...
export const slug = "mcpdotso";
export const title = "MCP.so";
export const hex = "1C3F6B";
...
export const url = "https://mcp.so";

const mcpdotso = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default mcpdotso;

// @thesvg/icons - AWS Systems Manager Maintenance Windows
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-maintenance-windows";
export const title = "AWS Systems Manager Maintenance Windows";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Maintenance Windows"];
...
const aws_res_aws_systems_manager_maintenance_windows = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_maintenance_windows;

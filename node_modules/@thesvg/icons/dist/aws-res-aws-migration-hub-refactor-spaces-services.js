// @thesvg/icons - AWS Migration Hub Refactor Spaces Services
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-migration-hub-refactor-spaces-services";
export const title = "AWS Migration Hub Refactor Spaces Services";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Refactor Spaces Services"];
...
const aws_res_aws_migration_hub_refactor_spaces_services = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_migration_hub_refactor_spaces_services;

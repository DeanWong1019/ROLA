// @thesvg/icons - AWS IoT Alexa_Skill
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-alexa-skill";
export const title = "AWS IoT Alexa_Skill";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Alexa_Skill"];
...
const aws_res_aws_iot_alexa_skill = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_alexa_skill;

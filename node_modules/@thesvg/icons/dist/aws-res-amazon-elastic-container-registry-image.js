// @thesvg/icons - Amazon Elastic Container Registry Image
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-container-registry-image";
export const title = "Amazon Elastic Container Registry Image";
export const hex = "ED7100";
export const categories = ["Containers"];
export const aliases = ["Image"];
...
const aws_res_amazon_elastic_container_registry_image = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_container_registry_image;

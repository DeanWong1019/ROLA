// @thesvg/icons - Amazon Elastic Container Service Container 3
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-container-service-container-3";
export const title = "Amazon Elastic Container Service Container 3";
export const hex = "ED7100";
export const categories = ["Containers"];
export const aliases = ["Container 3"];
...
const aws_res_amazon_elastic_container_service_container_3 = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_container_service_container_3;

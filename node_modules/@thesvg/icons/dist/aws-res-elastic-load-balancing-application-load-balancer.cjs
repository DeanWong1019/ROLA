...
exports.slug = "aws-res-elastic-load-balancing-application-load-balancer";
exports.title = "Elastic Load Balancing Application Load Balancer";
exports.hex = "8C4FFF";
exports.categories = ["Networking"];
exports.aliases = ["Application Load Balancer"];

// @thesvg/icons - Amazon EventBridge Scheduler
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-eventbridge-scheduler";
export const title = "Amazon EventBridge Scheduler";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Scheduler"];
...
const aws_res_amazon_eventbridge_scheduler = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_eventbridge_scheduler;

// @thesvg/icons - Amazon Elastic File System EFS One Zone
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-file-system-efs-one-zone";
export const title = "Amazon Elastic File System EFS One Zone";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["EFS One Zone"];
...
const aws_res_amazon_elastic_file_system_efs_one_zone = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_file_system_efs_one_zone;

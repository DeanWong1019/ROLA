// @thesvg/icons - AWS Storage Gateway Volume Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-storage-gateway-volume-gateway";
export const title = "AWS Storage Gateway Volume Gateway";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Volume Gateway"];
...
const aws_res_aws_storage_gateway_volume_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_storage_gateway_volume_gateway;

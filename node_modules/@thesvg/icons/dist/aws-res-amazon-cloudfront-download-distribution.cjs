...
exports.slug = "aws-res-amazon-cloudfront-download-distribution";
exports.title = "Amazon CloudFront Download Distribution";
exports.hex = "8C4FFF";
exports.categories = ["Networking"];
exports.aliases = ["Download Distribution"];

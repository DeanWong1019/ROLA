// @thesvg/icons - OpenClaw (MoltBot/ClawdBot)
...
export const url = "https://openclaw.dev";

const openclaw_moltbot_clawdbot = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default openclaw_moltbot_clawdbot;

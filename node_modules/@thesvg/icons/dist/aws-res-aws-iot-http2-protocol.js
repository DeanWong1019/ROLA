// @thesvg/icons - AWS IoT HTTP2 Protocol
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-http2-protocol";
export const title = "AWS IoT HTTP2 Protocol";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["HTTP2 Protocol"];
...
const aws_res_aws_iot_http2_protocol = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_http2_protocol;

// @thesvg/icons - Amazon Elastic File System File System
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-file-system-file-system";
export const title = "Amazon Elastic File System File System";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["File System"];
...
const aws_res_amazon_elastic_file_system_file_system = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_file_system_file_system;

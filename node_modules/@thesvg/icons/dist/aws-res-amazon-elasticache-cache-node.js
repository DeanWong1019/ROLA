// @thesvg/icons - Amazon ElastiCache Cache Node
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elasticache-cache-node";
export const title = "Amazon ElastiCache Cache Node";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Cache Node"];
...
const aws_res_amazon_elasticache_cache_node = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elasticache_cache_node;

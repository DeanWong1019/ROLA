// @thesvg/icons - AWS IoT Greengrass Stream Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-greengrass-stream-manager";
export const title = "AWS IoT Greengrass Stream Manager";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Stream Manager"];
...
const aws_res_aws_iot_greengrass_stream_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_greengrass_stream_manager;

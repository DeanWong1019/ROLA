...
exports.slug = "aws-res-aws-cloud-wan-transit-gateway-route-table-attachment";
exports.title = "AWS Cloud WAN Transit Gateway Route Table Attachment";
exports.hex = "8C4FFF";
exports.categories = ["Networking"];
exports.aliases = ["Transit Gateway Route Table Attachment"];

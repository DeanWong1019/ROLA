// @thesvg/icons - Amazon Simple Storage Service S3 Replication
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-s3-replication";
export const title = "Amazon Simple Storage Service S3 Replication";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["S3 Replication"];
...
const aws_res_amazon_simple_storage_service_s3_replication = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_s3_replication;

// @thesvg/icons - Amazon Route 53 Readiness Checks
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-route-53-readiness-checks";
export const title = "Amazon Route 53 Readiness Checks";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Readiness Checks"];
...
const aws_res_amazon_route_53_readiness_checks = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_route_53_readiness_checks;

// @thesvg/icons - AWS Organizations Organizational Unit
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-organizations-organizational-unit";
export const title = "AWS Organizations Organizational Unit";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Organizational Unit"];
...
const aws_res_aws_organizations_organizational_unit = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_organizations_organizational_unit;

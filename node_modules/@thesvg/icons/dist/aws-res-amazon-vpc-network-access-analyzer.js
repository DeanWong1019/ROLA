// @thesvg/icons - Amazon VPC Network Access Analyzer
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-network-access-analyzer";
export const title = "Amazon VPC Network Access Analyzer";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Network Access Analyzer"];
...
const aws_res_amazon_vpc_network_access_analyzer = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_network_access_analyzer;

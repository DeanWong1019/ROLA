// @thesvg/icons - AWS Amplify AWS Amplify Studio
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-amplify-aws-amplify-studio";
export const title = "AWS Amplify AWS Amplify Studio";
export const hex = "C7131F";
export const categories = ["Frontend"];
export const aliases = ["AWS Amplify Studio"];
...
const aws_res_aws_amplify_aws_amplify_studio = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_amplify_aws_amplify_studio;

// @thesvg/icons - Amazon Redshift Auto copy
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-redshift-auto-copy";
export const title = "Amazon Redshift Auto copy";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Auto copy"];
...
const aws_res_amazon_redshift_auto_copy = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_redshift_auto_copy;

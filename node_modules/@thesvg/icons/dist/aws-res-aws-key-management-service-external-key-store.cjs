...
exports.slug = "aws-res-aws-key-management-service-external-key-store";
exports.title = "AWS Key Management Service External Key Store";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["External Key Store"];

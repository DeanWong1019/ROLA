// @thesvg/icons - AWS IoT Policy
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-policy";
export const title = "AWS IoT Policy";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Policy"];
...
const aws_res_aws_iot_policy = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_policy;

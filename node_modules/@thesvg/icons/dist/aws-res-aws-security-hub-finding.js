// @thesvg/icons - AWS Security Hub Finding
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-security-hub-finding";
export const title = "AWS Security Hub Finding";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Finding"];
...
const aws_res_aws_security_hub_finding = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_security_hub_finding;

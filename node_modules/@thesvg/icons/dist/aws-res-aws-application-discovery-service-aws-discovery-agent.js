// @thesvg/icons - AWS Application Discovery Service AWS Discovery Agent
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-application-discovery-service-aws-discovery-agent";
export const title = "AWS Application Discovery Service AWS Discovery Agent";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["AWS Discovery Agent"];
...
const aws_res_aws_application_discovery_service_aws_discovery_agent = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_application_discovery_service_aws_discovery_agent;

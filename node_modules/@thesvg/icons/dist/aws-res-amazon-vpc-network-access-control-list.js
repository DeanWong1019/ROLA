// @thesvg/icons - Amazon VPC Network Access Control List
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-network-access-control-list";
export const title = "Amazon VPC Network Access Control List";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Network Access Control List"];
...
const aws_res_amazon_vpc_network_access_control_list = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_network_access_control_list;

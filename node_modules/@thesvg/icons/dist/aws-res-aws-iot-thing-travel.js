// @thesvg/icons - AWS IoT Thing_Travel
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-travel";
export const title = "AWS IoT Thing_Travel";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Travel"];
...
const aws_res_aws_iot_thing_travel = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_travel;

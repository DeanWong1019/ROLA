// @thesvg/icons - AWS IoT LoRaWAN Protocol
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-lorawan-protocol";
export const title = "AWS IoT LoRaWAN Protocol";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["LoRaWAN Protocol"];
...
const aws_res_aws_iot_lorawan_protocol = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_lorawan_protocol;

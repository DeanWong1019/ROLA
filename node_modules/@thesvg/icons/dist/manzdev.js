// @thesvg/icons - ManzDev
// Auto-generated. Do not edit.

export const slug = "manzdev";
export const title = "ManzDev";
export const hex = "000000";
export const categories = ["Community", "Platform"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 135 135">
...
export const variants = {
  "default": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 135 135">
  <g transform="translate(-9.76 -4.25) scale(.97747)">
    <path d="M30.92 101.94h8.73v-8.2h-8.73V26.8h8.47v-8.47h8.73v-9h66.67v9.8h16.14v33.6h-8.2v100.8H30.66Z" fill="#fff"
      transform="scale(.96438)rotate(-6.25 160.33 72.15)" />
    <path
...
export const url = "https://manz.dev/";

const manzdev = { slug, title, hex, categories, aliases, svg, variants, license, url };

...
export const slug = "valkey";
export const title = "Valkey";
export const hex = "FF6600";
export const categories = ["Database", "Software"];
export const aliases = ["Valkey DB"];
...
export const url = "https://valkey.io";

const valkey = { slug, title, hex, categories, aliases, svg, variants, license, url };

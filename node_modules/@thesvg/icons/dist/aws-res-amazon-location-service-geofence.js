// @thesvg/icons - Amazon Location Service Geofence
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-location-service-geofence";
export const title = "Amazon Location Service Geofence";
export const hex = "C7131F";
export const categories = ["Frontend"];
export const aliases = ["Geofence"];
...
const aws_res_amazon_location_service_geofence = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_location_service_geofence;

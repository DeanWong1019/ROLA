// @thesvg/icons - Amazon Simple Queue Service Message
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-queue-service-message";
export const title = "Amazon Simple Queue Service Message";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Message"];
...
const aws_res_amazon_simple_queue_service_message = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_queue_service_message;

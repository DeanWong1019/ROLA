// @thesvg/icons - Amazon DynamoDB Item
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-item";
export const title = "Amazon DynamoDB Item";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Item"];
...
const aws_res_amazon_dynamodb_item = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_item;

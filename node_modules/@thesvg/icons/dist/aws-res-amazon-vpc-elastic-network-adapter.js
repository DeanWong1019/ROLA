// @thesvg/icons - Amazon VPC Elastic Network Adapter
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-elastic-network-adapter";
export const title = "Amazon VPC Elastic Network Adapter";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Elastic Network Adapter"];
...
const aws_res_amazon_vpc_elastic_network_adapter = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_elastic_network_adapter;

// @thesvg/icons - AWS Trusted Advisor Checklist
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-trusted-advisor-checklist";
export const title = "AWS Trusted Advisor Checklist";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Checklist"];
...
const aws_res_aws_trusted_advisor_checklist = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_trusted_advisor_checklist;

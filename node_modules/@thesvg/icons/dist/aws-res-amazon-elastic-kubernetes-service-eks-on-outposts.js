// @thesvg/icons - Amazon Elastic Kubernetes Service EKS on Outposts
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-kubernetes-service-eks-on-outposts";
export const title = "Amazon Elastic Kubernetes Service EKS on Outposts";
export const hex = "ED7100";
export const categories = ["Containers"];
export const aliases = ["EKS on Outposts"];
...
const aws_res_amazon_elastic_kubernetes_service_eks_on_outposts = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_kubernetes_service_eks_on_outposts;

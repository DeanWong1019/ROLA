// @thesvg/icons - Amazon VPC Virtual private cloud VPC
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-virtual-private-cloud-vpc";
export const title = "Amazon VPC Virtual private cloud VPC";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Virtual private cloud VPC"];
...
const aws_res_amazon_vpc_virtual_private_cloud_vpc = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_virtual_private_cloud_vpc;

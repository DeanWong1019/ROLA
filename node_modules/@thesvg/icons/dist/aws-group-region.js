...
export const slug = "aws-group-region";
export const title = "Region";
...
const aws_group_region = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_group_region;

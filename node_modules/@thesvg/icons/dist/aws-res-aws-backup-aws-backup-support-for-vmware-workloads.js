// @thesvg/icons - AWS Backup AWS Backup Support for VMware Workloads
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-aws-backup-support-for-vmware-workloads";
export const title = "AWS Backup AWS Backup Support for VMware Workloads";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["AWS Backup Support for VMware Workloads"];
...
const aws_res_aws_backup_aws_backup_support_for_vmware_workloads = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_aws_backup_support_for_vmware_workloads;

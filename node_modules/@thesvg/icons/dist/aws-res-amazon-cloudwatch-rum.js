// @thesvg/icons - Amazon CloudWatch RUM
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-rum";
export const title = "Amazon CloudWatch RUM";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["RUM"];
...
const aws_res_amazon_cloudwatch_rum = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_rum;

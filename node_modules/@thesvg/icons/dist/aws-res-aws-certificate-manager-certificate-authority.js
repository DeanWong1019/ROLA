// @thesvg/icons - AWS Certificate Manager Certificate Authority
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-certificate-manager-certificate-authority";
export const title = "AWS Certificate Manager Certificate Authority";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Certificate Authority"];
...
const aws_res_aws_certificate_manager_certificate_authority = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_certificate_manager_certificate_authority;

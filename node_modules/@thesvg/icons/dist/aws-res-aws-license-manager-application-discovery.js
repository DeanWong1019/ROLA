// @thesvg/icons - AWS License Manager Application Discovery
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-license-manager-application-discovery";
export const title = "AWS License Manager Application Discovery";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Application Discovery"];
...
const aws_res_aws_license_manager_application_discovery = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_license_manager_application_discovery;

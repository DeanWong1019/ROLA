// @thesvg/icons - AWS IoT MQTT_Protocol
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-mqtt-protocol";
export const title = "AWS IoT MQTT_Protocol";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["MQTT_Protocol"];
...
const aws_res_aws_iot_mqtt_protocol = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_mqtt_protocol;

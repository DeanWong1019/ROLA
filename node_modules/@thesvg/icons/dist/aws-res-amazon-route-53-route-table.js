// @thesvg/icons - Amazon Route 53 Route Table
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-route-53-route-table";
export const title = "Amazon Route 53 Route Table";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Route Table"];
...
const aws_res_amazon_route_53_route_table = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_route_53_route_table;

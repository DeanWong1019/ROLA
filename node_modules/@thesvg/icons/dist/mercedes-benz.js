// @thesvg/icons - Mercedes-Benz
// Auto-generated. Do not edit.

export const slug = "mercedes-benz";
export const title = "Mercedes-Benz";
export const hex = "00ADEF";
export const categories = ["Automotive", "Platform"];
export const aliases = ["Mercedes"];
...
export const url = "https://www.mercedes-benz.com";

const mercedes_benz = { slug, title, hex, categories, aliases, svg, variants, license, url };

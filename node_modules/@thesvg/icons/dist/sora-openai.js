// @thesvg/icons - Sora (OpenAI)
// Auto-generated. Do not edit.

export const slug = "sora-openai";
export const title = "Sora (OpenAI)";
export const hex = "0968DA";
...
export const url = "https://platform.openai.com/docs/models/sora-2";

const sora_openai = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default sora_openai;

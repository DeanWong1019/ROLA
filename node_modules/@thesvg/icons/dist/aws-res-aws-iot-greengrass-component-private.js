// @thesvg/icons - AWS IoT Greengrass Component Private
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-greengrass-component-private";
export const title = "AWS IoT Greengrass Component Private";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Component Private"];
...
const aws_res_aws_iot_greengrass_component_private = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_greengrass_component_private;

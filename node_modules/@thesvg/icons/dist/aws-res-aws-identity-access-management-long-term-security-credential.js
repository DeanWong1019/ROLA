// @thesvg/icons - AWS Identity Access Management Long Term Security Credential
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-long-term-security-credential";
export const title = "AWS Identity Access Management Long Term Security Credential";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Long Term Security Credential"];
...
const aws_res_aws_identity_access_management_long_term_security_credential = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_long_term_security_credential;

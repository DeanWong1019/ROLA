// @thesvg/icons - AWS WAF Filtering Rule
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-waf-filtering-rule";
export const title = "AWS WAF Filtering Rule";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Filtering Rule"];
...
const aws_res_aws_waf_filtering_rule = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_waf_filtering_rule;

...
exports.slug = "aws-res-aws-identity-access-management-temporary-security-credential";
exports.title = "AWS Identity Access Management Temporary Security Credential";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["Temporary Security Credential"];

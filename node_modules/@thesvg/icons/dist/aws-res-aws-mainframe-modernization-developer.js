// @thesvg/icons - AWS Mainframe Modernization Developer
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-mainframe-modernization-developer";
export const title = "AWS Mainframe Modernization Developer";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Developer"];
...
const aws_res_aws_mainframe_modernization_developer = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_mainframe_modernization_developer;

// @thesvg/icons - AWS Elemental MediaConnect MediaConnect Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-elemental-mediaconnect-mediaconnect-gateway";
export const title = "AWS Elemental MediaConnect MediaConnect Gateway";
export const hex = "ED7100";
export const categories = ["Media"];
export const aliases = ["MediaConnect Gateway"];
...
const aws_res_aws_elemental_mediaconnect_mediaconnect_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_elemental_mediaconnect_mediaconnect_gateway;

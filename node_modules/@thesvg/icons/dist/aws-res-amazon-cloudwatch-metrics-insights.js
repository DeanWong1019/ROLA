// @thesvg/icons - Amazon CloudWatch Metrics Insights
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-metrics-insights";
export const title = "Amazon CloudWatch Metrics Insights";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Metrics Insights"];
...
const aws_res_amazon_cloudwatch_metrics_insights = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_metrics_insights;

// @thesvg/icons - AWS Lake Formation Data Lake
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-lake-formation-data-lake";
export const title = "AWS Lake Formation Data Lake";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Data Lake"];
...
const aws_res_aws_lake_formation_data_lake = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_lake_formation_data_lake;

// @thesvg/icons - Amazon DynamoDB Amazon DynamoDB Accelerator
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-amazon-dynamodb-accelerator";
export const title = "Amazon DynamoDB Amazon DynamoDB Accelerator";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Amazon DynamoDB Accelerator"];
...
const aws_res_amazon_dynamodb_amazon_dynamodb_accelerator = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_amazon_dynamodb_accelerator;

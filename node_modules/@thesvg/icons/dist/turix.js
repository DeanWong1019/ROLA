...
export const slug = "turix";
export const title = "TuriX";
export const hex = "F7AD8A";
...
export const url = "https://turix.ai";

const turix = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default turix;

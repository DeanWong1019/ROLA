// @thesvg/icons - Amazon Route 53 Routing Controls
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-route-53-routing-controls";
export const title = "Amazon Route 53 Routing Controls";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Routing Controls"];
...
const aws_res_amazon_route_53_routing_controls = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_route_53_routing_controls;

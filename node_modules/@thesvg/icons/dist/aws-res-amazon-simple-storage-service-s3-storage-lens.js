// @thesvg/icons - Amazon Simple Storage Service S3 Storage Lens
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-s3-storage-lens";
export const title = "Amazon Simple Storage Service S3 Storage Lens";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["S3 Storage Lens"];
...
const aws_res_amazon_simple_storage_service_s3_storage_lens = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_s3_storage_lens;

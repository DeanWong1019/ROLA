// @thesvg/icons - Amazon Braket Managed Simulator
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-braket-managed-simulator";
export const title = "Amazon Braket Managed Simulator";
export const hex = "ED7100";
export const categories = ["Quantum"];
export const aliases = ["Managed Simulator"];
...
const aws_res_amazon_braket_managed_simulator = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_braket_managed_simulator;

// @thesvg/icons - AWS Migration Hub Refactor Spaces Applications
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-migration-hub-refactor-spaces-applications";
export const title = "AWS Migration Hub Refactor Spaces Applications";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Refactor Spaces Applications"];
...
const aws_res_aws_migration_hub_refactor_spaces_applications = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_migration_hub_refactor_spaces_applications;

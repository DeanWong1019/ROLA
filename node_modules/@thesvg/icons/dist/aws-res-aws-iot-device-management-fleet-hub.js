// @thesvg/icons - AWS IoT Device Management Fleet Hub
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-device-management-fleet-hub";
export const title = "AWS IoT Device Management Fleet Hub";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Fleet Hub"];
...
const aws_res_aws_iot_device_management_fleet_hub = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_device_management_fleet_hub;

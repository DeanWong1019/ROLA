// @thesvg/icons - AWS Systems Manager Inventory
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-inventory";
export const title = "AWS Systems Manager Inventory";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Inventory"];
...
const aws_res_aws_systems_manager_inventory = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_inventory;

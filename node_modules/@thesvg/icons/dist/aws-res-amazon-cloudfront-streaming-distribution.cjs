...
exports.slug = "aws-res-amazon-cloudfront-streaming-distribution";
exports.title = "Amazon CloudFront Streaming Distribution";
exports.hex = "8C4FFF";
exports.categories = ["Networking"];
exports.aliases = ["Streaming Distribution"];

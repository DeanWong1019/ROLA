...
export const slug = "glm-v";
export const title = "GLM-V";
export const hex = "0039C6";
...
export const url = "https://huggingface.co/zai-org/GLM-4.1V-9B-Thinking";

const glm_v = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default glm_v;

// @thesvg/icons - AWS Lambda Lambda Function
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-lambda-lambda-function";
export const title = "AWS Lambda Lambda Function";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["Lambda Function"];
...
const aws_res_aws_lambda_lambda_function = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_lambda_lambda_function;

// @thesvg/icons - AWS Mainframe Modernization Converter
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-mainframe-modernization-converter";
export const title = "AWS Mainframe Modernization Converter";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Converter"];
...
const aws_res_aws_mainframe_modernization_converter = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_mainframe_modernization_converter;

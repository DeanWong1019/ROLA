// @thesvg/icons - AWS Network Firewall Endpoints
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-network-firewall-endpoints";
export const title = "AWS Network Firewall Endpoints";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Endpoints"];
...
const aws_res_aws_network_firewall_endpoints = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_network_firewall_endpoints;

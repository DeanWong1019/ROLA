// @thesvg/icons - Amazon OpenSearch Service UltraWarm Node
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-opensearch-service-ultrawarm-node";
export const title = "Amazon OpenSearch Service UltraWarm Node";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["UltraWarm Node"];
...
const aws_res_amazon_opensearch_service_ultrawarm_node = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_opensearch_service_ultrawarm_node;

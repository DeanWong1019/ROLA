// @thesvg/icons - AWS IoT Servo
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-servo";
export const title = "AWS IoT Servo";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Servo"];
...
const aws_res_aws_iot_servo = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_servo;

// @thesvg/icons - AWS Systems Manager Parameter Store
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-parameter-store";
export const title = "AWS Systems Manager Parameter Store";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Parameter Store"];
...
const aws_res_aws_systems_manager_parameter_store = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_parameter_store;

// @thesvg/icons - Amazon CloudSearch Search Documents
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudsearch-search-documents";
export const title = "Amazon CloudSearch Search Documents";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Search Documents"];
...
const aws_res_amazon_cloudsearch_search_documents = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudsearch_search_documents;

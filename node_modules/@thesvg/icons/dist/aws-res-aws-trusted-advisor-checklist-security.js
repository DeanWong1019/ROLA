// @thesvg/icons - AWS Trusted Advisor Checklist Security
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-trusted-advisor-checklist-security";
export const title = "AWS Trusted Advisor Checklist Security";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Checklist Security"];
...
const aws_res_aws_trusted_advisor_checklist_security = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_trusted_advisor_checklist_security;

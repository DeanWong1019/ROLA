// @thesvg/icons - AWS Cloud WAN Core Network Edge
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloud-wan-core-network-edge";
export const title = "AWS Cloud WAN Core Network Edge";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Core Network Edge"];
...
const aws_res_aws_cloud_wan_core_network_edge = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloud_wan_core_network_edge;

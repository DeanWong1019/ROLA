// @thesvg/icons - AWS Identity Access Management Encrypted Data
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-encrypted-data";
export const title = "AWS Identity Access Management Encrypted Data";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Encrypted Data"];
...
const aws_res_aws_identity_access_management_encrypted_data = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_encrypted_data;

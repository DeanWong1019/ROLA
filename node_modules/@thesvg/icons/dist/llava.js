...
export const slug = "llava";
export const title = "LLaVA";
export const hex = "CB2D30";
    ...
    >
      ...
      <defs>
        <radialGradient
          ...
          r="94.548%"
        >
          <stop offset="17.43%" stop-color="#E79F68" />
          <stop offset="27.76%" stop-color="#E6A272" />
          <stop offset="45.28%" stop-color="#E3AB8D" />
          <stop offset="53.12%" stop-color="#E2AF9B" />
          <stop offset="78.33%" stop-color="#E1D1CC" />
          <stop offset="88.28%" stop-color="#E0E0E0" />
        </radialGradient>
        <radialGradient
          cx="46.574%"
          cy="-17.021%"
          ...
          r="104.429%"
        >
          <stop offset="38.96%" stop-color="#CB2D30" />
          <stop offset="49.16%" stop-color="#D23730" />
          <stop offset="66.46%" stop-color="#E45231" />
          <stop offset="71.53%" stop-color="#EA5B31" />
          <stop offset="79.21%" stop-color="#EA6032" />
          <stop offset="88.7%" stop-color="#EC6F36" />
          <stop offset="96.72%" stop-color="#ED823A" />
        </radialGradient>
        <radialGradient
          cx="-27.509%"
          cy="-21.261%"
          ...
          r="247.627%"
        >
          <stop offset="4.48%" stop-color="#CB2D30" />
          <stop offset="34.39%" stop-color="#D23730" />
          <stop offset="85.12%" stop-color="#E45231" />
          <stop offset="100%" stop-color="#EA5B31" />
        </radialGradient>
        <radialGradient
          cx="-29.546%"
          cy="-14.202%"
          ...
          r="145.983%"
        >
          <stop offset="29.39%" stop-color="#CB2D30" />
          <stop offset="51.49%" stop-color="#D23730" />
          <stop offset="89%" stop-color="#E45231" />
          <stop offset="100%" stop-color="#EA5B31" />
        </radialGradient>
        <radialGradient
          cx="-1.091%"
        ...
        <radialGradient
          ...
          r="149.345%"
        >
          <stop offset="42.32%" stop-color="#CB2D30" />
          <stop offset="60.38%" stop-color="#D23730" />
          <stop offset="91.02%" stop-color="#E45231" />
          <stop offset="100%" stop-color="#EA5B31" />
        </radialGradient>
        <radialGradient
          cx="129.457%"
          ...
          r="139.942%"
        >
          <stop offset="34.06%" stop-color="#CB2D30" />
          <stop offset="54.7%" stop-color="#D23730" />
          <stop offset="89.73%" stop-color="#E45231" />
          <stop offset="100%" stop-color="#EA5B31" />
        </radialGradient>
        <radialGradient
          cx="95.294%"
          ...
          r="328.308%"
        >
          <stop offset="48.33%" stop-color="#CB2D30" />
          <stop offset="64.51%" stop-color="#D23730" />
          <stop offset="91.95%" stop-color="#E45231" />
          <stop offset="100%" stop-color="#EA5B31" />
        </radialGradient>
        <radialGradient
          cx="50.033%"
        ...
        <radialGradient
          ...
          r="121.766%"
        >
          <stop offset="39.43%" stop-color="#CB2D30" />
          <stop offset="58.39%" stop-color="#D23730" />
          <stop offset="90.57%" stop-color="#E45231" />
          <stop offset="100%" stop-color="#EA5B31" />
        </radialGradient>
        <radialGradient
          cx="137.282%"
          ...
          r="126.759%"
        >
          <stop offset="42.05%" stop-color="#CB2D30" />
          <stop offset="60.19%" stop-color="#D23730" />
          <stop offset="90.97%" stop-color="#E45231" />
          <stop offset="100%" stop-color="#EA5B31" />
        </radialGradient>
      </defs>
    </svg>`;
...
export const url = "https://github.com/haotian-liu/LLaVA";

const llava = { slug, title, hex, categories, aliases, svg, variants, license, url };

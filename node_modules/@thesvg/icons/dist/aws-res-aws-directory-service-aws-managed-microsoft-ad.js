// @thesvg/icons - AWS Directory Service AWS Managed Microsoft AD
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-directory-service-aws-managed-microsoft-ad";
export const title = "AWS Directory Service AWS Managed Microsoft AD";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["AWS Managed Microsoft AD"];
...
const aws_res_aws_directory_service_aws_managed_microsoft_ad = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_directory_service_aws_managed_microsoft_ad;

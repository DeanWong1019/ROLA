// @thesvg/icons - Amazon VPC Traffic Mirroring
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-traffic-mirroring";
export const title = "Amazon VPC Traffic Mirroring";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Traffic Mirroring"];
...
const aws_res_amazon_vpc_traffic_mirroring = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_traffic_mirroring;

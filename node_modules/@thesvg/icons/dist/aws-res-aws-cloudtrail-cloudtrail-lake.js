// @thesvg/icons - AWS CloudTrail CloudTrail Lake
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloudtrail-cloudtrail-lake";
export const title = "AWS CloudTrail CloudTrail Lake";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["CloudTrail Lake"];
...
const aws_res_aws_cloudtrail_cloudtrail_lake = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloudtrail_cloudtrail_lake;

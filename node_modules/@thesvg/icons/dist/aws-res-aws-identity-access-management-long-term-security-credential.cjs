...
exports.slug = "aws-res-aws-identity-access-management-long-term-security-credential";
exports.title = "AWS Identity Access Management Long Term Security Credential";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["Long Term Security Credential"];

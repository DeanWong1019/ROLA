// @thesvg/icons - AWS IoT Thing_Bicycle
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-bicycle";
export const title = "AWS IoT Thing_Bicycle";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Bicycle"];
...
const aws_res_aws_iot_thing_bicycle = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_bicycle;

// @thesvg/icons - AWS IoT Reported State
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-reported-state";
export const title = "AWS IoT Reported State";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Reported State"];
...
const aws_res_aws_iot_reported_state = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_reported_state;

// @thesvg/icons - Microsoft Azure
// Auto-generated. Do not edit.

export const slug = "microsoft-azure";
export const title = "Microsoft Azure";
export const hex = "fff";
export const categories = ["Software", "Microsoft"];
export const aliases = [];
export const svg = `<svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const variants = {
  "default": `<svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="a" x1="-1032.17" x2="-1059.21" y1="145.31" y2="65.43" gradientTransform="matrix(1 0 0 -1 1075 158)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#114a8b"/>
      <stop offset="1" stop-color="#0669bc"/>
...
export const url = "https://azure.microsoft.com/";

const microsoft_azure = { slug, title, hex, categories, aliases, svg, variants, license, url };

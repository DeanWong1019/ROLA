// @thesvg/icons - AWS Systems Manager Compliance
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-compliance";
export const title = "AWS Systems Manager Compliance";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Compliance"];
...
const aws_res_aws_systems_manager_compliance = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_compliance;

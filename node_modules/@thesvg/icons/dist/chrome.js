...
export const slug = "chrome";
export const title = "Chrome";
...
export const url = "https://chrome.com/";

const chrome = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - NousResearch (Hermes)
// Auto-generated. Do not edit.

export const slug = "nousresearch-hermes";
export const title = "NousResearch (Hermes)";
export const hex = "2D6376";
...
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd">
  <title>NousResearch (Hermes)</title>
...
export const url = "https://nousresearch.com";

const nousresearch_hermes = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default nousresearch_hermes;

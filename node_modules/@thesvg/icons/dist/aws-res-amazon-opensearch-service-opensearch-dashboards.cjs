...
exports.slug = "aws-res-amazon-opensearch-service-opensearch-dashboards";
exports.title = "Amazon OpenSearch Service OpenSearch Dashboards";
exports.hex = "8C4FFF";
exports.categories = ["Analytics"];
exports.aliases = ["OpenSearch Dashboards"];

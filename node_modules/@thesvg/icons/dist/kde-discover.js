// @thesvg/icons - KDE Discover
// Auto-generated. Do not edit.

export const slug = "kde-discover";
export const title = "KDE Discover";
export const hex = "1D99F3";
export const categories = ["Software", "Linux"];
export const aliases = [];
export const svg = `<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
 <defs>
...
export const variants = {
  "default": `<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
 <defs>
  <linearGradient id="a" y1="543.8" y2="513.8" x2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1.125 0 0 1-51.07 0)">
   <stop stop-color="#197cf1"/>
   <stop offset="1" stop-color="#20bcfa"/>
...
export const url = "https://apps.kde.org/discover/";

const kde_discover = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default kde_discover;

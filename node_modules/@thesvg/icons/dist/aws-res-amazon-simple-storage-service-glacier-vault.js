// @thesvg/icons - Amazon Simple Storage Service Glacier Vault
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-glacier-vault";
export const title = "Amazon Simple Storage Service Glacier Vault";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Vault"];
...
const aws_res_amazon_simple_storage_service_glacier_vault = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_glacier_vault;

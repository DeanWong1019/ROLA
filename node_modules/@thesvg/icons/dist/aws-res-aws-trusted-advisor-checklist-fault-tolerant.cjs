...
exports.slug = "aws-res-aws-trusted-advisor-checklist-fault-tolerant";
exports.title = "AWS Trusted Advisor Checklist Fault Tolerant";
exports.hex = "232F3E";
exports.categories = ["Management Governance"];
exports.aliases = ["Checklist Fault Tolerant"];

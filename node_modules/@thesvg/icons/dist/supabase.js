// @thesvg/icons - Supabase
// Auto-generated. Do not edit.

export const slug = "supabase";
export const title = "Supabase";
export const hex = "3FCF8E";
export const categories = ["Database", "Software"];
export const aliases = [];
export const svg = `<svg viewBox="0 0 109 113" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const variants = {
  "default": `<svg viewBox="0 0 109 113" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M63.7076 110.284C60.8481 113.885 55.0502 111.912 54.9813 107.314L53.9738 40.0627L99.1935 40.0627C107.384 40.0627 111.952 49.5228 106.859 55.9374L63.7076 110.284Z" fill="url(#paint0_linear)"/>
<path d="M63.7076 110.284C60.8481 113.885 55.0502 111.912 54.9813 107.314L53.9738 40.0627L99.1935 40.0627C107.384 40.0627 111.952 49.5228 106.859 55.9374L63.7076 110.284Z" fill="url(#paint1_linear)" fill-opacity="0.2"/>
<path d="M45.317 2.07103C48.1765 -1.53037 53.9745 0.442937 54.0434 5.041L54.4849 72.2922H9.83113C1.64038 72.2922 -2.92775 62.8321 2.1655 56.4175L45.317 2.07103Z" fill="#3ECF8E"/>
<defs>
...
<stop offset="1" stop-opacity="0"/>
  ...
  "mono": `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Supabase</title><path d="M11.9 1.036c-.015-.986-1.26-1.41-1.874-.637L.764 12.05C-.33 13.427.65 15.455 2.409 15.455h9.579l.113 7.51c.014.985 1.259 1.408 1.873.636l9.262-11.653c1.093-1.375.113-3.403-1.645-3.403h-9.642z"/></svg>`,
  "wordmark": `<svg viewBox="0 0 581 113" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const url = "https://supabase.com/";

const supabase = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - Amazon Pinpoint Journey
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-pinpoint-journey";
export const title = "Amazon Pinpoint Journey";
export const hex = "C7131F";
export const categories = ["Business"];
export const aliases = ["Journey"];
...
const aws_res_amazon_pinpoint_journey = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_pinpoint_journey;

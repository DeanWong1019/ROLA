// @thesvg/icons - AWS Systems Manager OpsCenter
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-opscenter";
export const title = "AWS Systems Manager OpsCenter";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["OpsCenter"];
...
const aws_res_aws_systems_manager_opscenter = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_opscenter;

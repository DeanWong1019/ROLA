// @thesvg/icons - AWS IoT Shadow
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-shadow";
export const title = "AWS IoT Shadow";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Shadow"];
...
const aws_res_aws_iot_shadow = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_shadow;

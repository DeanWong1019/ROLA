...
export const slug = "kroger";
export const title = "Kroger";
export const hex = "0033A0";
export const categories = ["Shopping", "Software"];
export const aliases = [];
export const svg = `<svg version="1.1" id="Layer_1" xmlns:x="ns_extend;" xmlns:i="ns_ai;" xmlns:graph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 95.1 74.1" style="enable-background:new 0 0 95.1 74.1;" xml:space="preserve">
 <style type="text/css">
  .st0{fill:#FFFFFF;}
 </style>
 <metadata>
  <sfw xmlns="ns_sfw;">
   ...
   <sliceSourceBounds bottomLeftOrigin="true" height="74.1" width="95.1" x="269.7" y="42.4">
   </sliceSourceBounds>
  </sfw>
 </metadata>
 <g>
  <path class="st0" d="M36.4,67.8c0,3.4-2.9,6.2-6.3,6.1c-3.4,0-6.2-2.9-6.1-6.3c0-3.4,2.8-6.1,6.2-6.1
		C33.6,61.5,36.4,64.3,36.4,67.8C36.4,67.7,36.4,67.8,36.4,67.8z">
  </path>
  <ellipse class="st0" cx="81.6" cy="67.8" rx="6.2" ry="6.3">
  </ellipse>
  <path class="st0" d="M29.8,26.5c0-0.4,0.1-0.8,0.3-1.1c0.3-0.3,0.7-0.5,1.1-0.5h16.9c0.5,0,1,0.3,1.2,0.7c0.3,0.4,0.3,1,0,1.4
  ...
  <path class="st0" d="M84.8,24.9c-1,14.5-12.3,26.7-27.1,28c-16.4,1.5-31-10.8-32.5-27.4C23.8,10.5,14.2,0.7,0,0v10.5
		c8.8,0.6,14.1,6.3,15,16c1.9,21.1,19.5,37,40,37c1.2,0,2.5-0.1,3.7-0.2c20.1-1.9,35.4-18.6,36.4-38.4L84.8,24.9z">
  </path>
 </g>
</svg>`;
export const variants = {
  "default": `<svg version="1.1" id="Layer_1" xmlns:x="ns_extend;" xmlns:i="ns_ai;" xmlns:graph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 95.1 74.1" style="enable-background:new 0 0 95.1 74.1;" xml:space="preserve">
 <style type="text/css">
  .st0{fill:#FFFFFF;}
 </style>
 <metadata>
 ...
 <g>
  ...
  "wordmark": `<svg version="1.1" id="Layer_1" xmlns:x="ns_extend;" xmlns:i="ns_ai;" xmlns:graph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 342 127" style="enable-background:new 0 0 342 127;" xml:space="preserve">
 <style type="text/css">
  .st0{fill:#21409A;}
 </style>
 <metadata>
  <sfw xmlns="ns_sfw;">
   ...
   <sliceSourceBounds bottomLeftOrigin="true" height="127" width="342" x="269.7" y="0">
   </sliceSourceBounds>
  </sfw>
 </metadata>
 <g>
...
export const url = "https://www.kroger.com";

const kroger = { slug, title, hex, categories, aliases, svg, variants, license, url };

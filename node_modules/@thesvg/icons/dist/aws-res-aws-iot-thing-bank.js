// @thesvg/icons - AWS IoT Thing_Bank
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-bank";
export const title = "AWS IoT Thing_Bank";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Bank"];
...
const aws_res_aws_iot_thing_bank = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_bank;

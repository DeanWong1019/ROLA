// @thesvg/icons - Amazon File Cache S3 linked datasets
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-file-cache-s3-linked-datasets";
export const title = "Amazon File Cache S3 linked datasets";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["S3 linked datasets"];
...
const aws_res_amazon_file_cache_s3_linked_datasets = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_file_cache_s3_linked_datasets;

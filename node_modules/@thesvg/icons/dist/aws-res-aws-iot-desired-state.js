// @thesvg/icons - AWS IoT Desired State
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-desired-state";
export const title = "AWS IoT Desired State";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Desired State"];
...
const aws_res_aws_iot_desired_state = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_desired_state;

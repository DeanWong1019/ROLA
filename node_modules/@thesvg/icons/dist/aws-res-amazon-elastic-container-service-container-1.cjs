...
exports.slug = "aws-res-amazon-elastic-container-service-container-1";
exports.title = "Amazon Elastic Container Service Container 1";
exports.hex = "ED7100";
exports.categories = ["Containers"];
exports.aliases = ["Container 1"];

// @thesvg/icons - AWS IoT Core Device Location
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-core-device-location";
export const title = "AWS IoT Core Device Location";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Device Location"];
...
const aws_res_aws_iot_core_device_location = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_core_device_location;

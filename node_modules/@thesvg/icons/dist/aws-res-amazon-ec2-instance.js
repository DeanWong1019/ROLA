// @thesvg/icons - Amazon EC2 Instance
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-ec2-instance";
export const title = "Amazon EC2 Instance";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["Instance"];
...
const aws_res_amazon_ec2_instance = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_ec2_instance;

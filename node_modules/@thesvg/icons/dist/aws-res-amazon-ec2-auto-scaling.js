...
export const slug = "aws-res-amazon-ec2-auto-scaling";
export const title = "Amazon EC2 Auto Scaling";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["Auto Scaling"];
...
const aws_res_amazon_ec2_auto_scaling = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_ec2_auto_scaling;

// @thesvg/icons - Amazon CloudFront Streaming Distribution
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudfront-streaming-distribution";
export const title = "Amazon CloudFront Streaming Distribution";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Streaming Distribution"];
...
const aws_res_amazon_cloudfront_streaming_distribution = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudfront_streaming_distribution;

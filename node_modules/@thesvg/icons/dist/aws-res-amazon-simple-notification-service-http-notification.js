// @thesvg/icons - Amazon Simple Notification Service HTTP Notification
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-notification-service-http-notification";
export const title = "Amazon Simple Notification Service HTTP Notification";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["HTTP Notification"];
...
const aws_res_amazon_simple_notification_service_http_notification = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_notification_service_http_notification;

// @thesvg/icons - Network Rail
// Auto-generated. Do not edit.

export const slug = "network-rail";
export const title = "Network Rail";
export const hex = "E21836";
export const categories = ["Platform"];
export const aliases = [];
export const svg = `<svg style="fill: currentColor" width="128px" height="48px" class="" role="img" xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-label="nr_logo_gradient icon" viewBox="0 200 652 250" xmlns:xlink="http://www.w3.org/1999/xlink">
 <title>
  Network Rail
 </title>
 <defs>
...
export const url = "https://www.networkrail.co.uk";

const network_rail = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default network_rail;

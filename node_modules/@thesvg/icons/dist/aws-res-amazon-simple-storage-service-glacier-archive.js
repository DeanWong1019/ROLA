// @thesvg/icons - Amazon Simple Storage Service Glacier Archive
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-glacier-archive";
export const title = "Amazon Simple Storage Service Glacier Archive";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Archive"];
...
const aws_res_amazon_simple_storage_service_glacier_archive = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_glacier_archive;

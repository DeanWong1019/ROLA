// @thesvg/icons - AWS Storage Gateway Virtual Tape Library
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-storage-gateway-virtual-tape-library";
export const title = "AWS Storage Gateway Virtual Tape Library";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Virtual Tape Library"];
...
const aws_res_aws_storage_gateway_virtual_tape_library = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_storage_gateway_virtual_tape_library;

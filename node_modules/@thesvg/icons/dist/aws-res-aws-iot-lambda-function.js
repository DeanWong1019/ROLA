// @thesvg/icons - AWS IoT Lambda_Function
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-lambda-function";
export const title = "AWS IoT Lambda_Function";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Lambda_Function"];
...
const aws_res_aws_iot_lambda_function = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_lambda_function;

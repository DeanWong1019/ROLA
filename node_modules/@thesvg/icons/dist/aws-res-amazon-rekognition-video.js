// @thesvg/icons - Amazon Rekognition Video
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-rekognition-video";
export const title = "Amazon Rekognition Video";
export const hex = "01A88D";
export const categories = ["AI"];
export const aliases = ["Video"];
...
const aws_res_amazon_rekognition_video = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_rekognition_video;

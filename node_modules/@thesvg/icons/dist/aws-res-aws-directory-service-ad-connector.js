// @thesvg/icons - AWS Directory Service AD Connector
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-directory-service-ad-connector";
export const title = "AWS Directory Service AD Connector";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["AD Connector"];
...
const aws_res_aws_directory_service_ad_connector = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_directory_service_ad_connector;

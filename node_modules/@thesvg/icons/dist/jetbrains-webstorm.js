// @thesvg/icons - JetBrains WebStorm
// Auto-generated. Do not edit.

export const slug = "jetbrains-webstorm";
export const title = "JetBrains WebStorm";
export const hex = "000000";
export const categories = ["Software", "Platform"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 105 105">
...
export const variants = {
  "default": `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 105 105">
  <linearGradient id="a" x1="38.88" x2="63.72" y1="6.5" y2="95.94" gradientUnits="userSpaceOnUse">
    <stop offset=".28" stop-color="#07c3f2"/>
    <stop offset=".94" stop-color="#087cfa"/>
  </linearGradient>
...
export const url = "https://www.jetbrains.com/webstorm/";

const jetbrains_webstorm = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default jetbrains_webstorm;

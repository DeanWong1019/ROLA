// @thesvg/icons - Amazon Braket Chandelier
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-braket-chandelier";
export const title = "Amazon Braket Chandelier";
export const hex = "ED7100";
export const categories = ["Quantum"];
export const aliases = ["Chandelier"];
...
const aws_res_amazon_braket_chandelier = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_braket_chandelier;

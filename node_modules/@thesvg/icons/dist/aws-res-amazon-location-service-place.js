// @thesvg/icons - Amazon Location Service Place
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-location-service-place";
export const title = "Amazon Location Service Place";
export const hex = "C7131F";
export const categories = ["Frontend"];
export const aliases = ["Place"];
...
const aws_res_amazon_location_service_place = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_location_service_place;

// @thesvg/icons - Amazon DynamoDB Stream
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-stream";
export const title = "Amazon DynamoDB Stream";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Stream"];
...
const aws_res_amazon_dynamodb_stream = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_stream;

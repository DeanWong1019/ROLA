// @thesvg/icons - Amazon CloudWatch Event Event Based
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-event-event-based";
export const title = "Amazon CloudWatch Event Event Based";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Event Event Based"];
...
const aws_res_amazon_cloudwatch_event_event_based = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_event_event_based;

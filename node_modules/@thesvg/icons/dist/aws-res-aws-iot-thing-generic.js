// @thesvg/icons - AWS IoT Thing_Generic
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-generic";
export const title = "AWS IoT Thing_Generic";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Generic"];
...
const aws_res_aws_iot_thing_generic = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_generic;

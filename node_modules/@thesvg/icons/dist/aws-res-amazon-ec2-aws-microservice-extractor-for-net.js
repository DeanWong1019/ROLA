// @thesvg/icons - Amazon EC2 AWS Microservice Extractor for .NET
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-ec2-aws-microservice-extractor-for-net";
export const title = "Amazon EC2 AWS Microservice Extractor for .NET";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["AWS Microservice Extractor for .NET"];
...
const aws_res_amazon_ec2_aws_microservice_extractor_for_net = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_ec2_aws_microservice_extractor_for_net;

// @thesvg/icons - Amazon Simple Storage Service S3 One Zone IA
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-s3-one-zone-ia";
export const title = "Amazon Simple Storage Service S3 One Zone IA";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["S3 One Zone IA"];
...
const aws_res_amazon_simple_storage_service_s3_one_zone_ia = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_s3_one_zone_ia;

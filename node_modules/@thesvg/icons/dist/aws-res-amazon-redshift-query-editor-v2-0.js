// @thesvg/icons - Amazon Redshift Query Editor v2.0
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-redshift-query-editor-v2-0";
export const title = "Amazon Redshift Query Editor v2.0";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Query Editor v2.0"];
...
const aws_res_amazon_redshift_query_editor_v2_0 = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_redshift_query_editor_v2_0;

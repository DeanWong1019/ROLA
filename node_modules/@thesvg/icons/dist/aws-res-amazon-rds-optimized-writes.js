// @thesvg/icons - Amazon RDS Optimized Writes
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-rds-optimized-writes";
export const title = "Amazon RDS Optimized Writes";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Optimized Writes"];
...
const aws_res_amazon_rds_optimized_writes = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_rds_optimized_writes;

// @thesvg/icons - AWS Direct Connect Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-direct-connect-gateway";
export const title = "AWS Direct Connect Gateway";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Gateway"];
...
const aws_res_aws_direct_connect_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_direct_connect_gateway;

// @thesvg/icons - Amazon CloudFront Download Distribution
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudfront-download-distribution";
export const title = "Amazon CloudFront Download Distribution";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Download Distribution"];
...
const aws_res_amazon_cloudfront_download_distribution = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudfront_download_distribution;

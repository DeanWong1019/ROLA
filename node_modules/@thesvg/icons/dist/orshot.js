...
export const slug = "orshot";
export const title = "Orshot";
export const hex = "111111";
export const categories = ["Platform", "Design", "Automation", "AI"];
...
export const url = "https://orshot.com";

const orshot = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - AWS Backup Vault Lock
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-vault-lock";
export const title = "AWS Backup Vault Lock";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Vault Lock"];
...
const aws_res_aws_backup_vault_lock = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_vault_lock;

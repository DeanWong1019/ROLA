...
exports.slug = "aws-res-amazon-simple-storage-service-s3-glacier-deep-archive";
exports.title = "Amazon Simple Storage Service S3 Glacier Deep Archive";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["S3 Glacier Deep Archive"];

// @thesvg/icons - AWS IoT Thing_Car
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-car";
export const title = "AWS IoT Thing_Car";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Car"];
...
const aws_res_aws_iot_thing_car = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_car;

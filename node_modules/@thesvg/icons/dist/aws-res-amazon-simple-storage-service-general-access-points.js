// @thesvg/icons - Amazon Simple Storage Service General Access Points
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-general-access-points";
export const title = "Amazon Simple Storage Service General Access Points";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["General Access Points"];
...
const aws_res_amazon_simple_storage_service_general_access_points = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_general_access_points;

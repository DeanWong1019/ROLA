...
exports.slug = "docsearch";
exports.title = "DocSearch";
exports.hex = "fff";
exports.categories = ["Software", "Platform"];
exports.aliases = [];
exports.svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
exports.license = "MIT";
exports.url = "https://docsearch.algolia.com";

...
export const slug = "amazon-q";
export const title = "Amazon Q";
...
export const url = "https://aws.amazon.com/q";

const amazon_q = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default amazon_q;

...
exports.slug = "aws-res-amazon-cloudwatch-cross-account-observability";
exports.title = "Amazon CloudWatch Cross account Observability";
exports.hex = "232F3E";
exports.categories = ["Management Governance"];
exports.aliases = ["Cross account Observability"];

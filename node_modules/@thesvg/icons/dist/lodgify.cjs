...
exports.slug = "lodgify";
exports.title = "Lodgify";
exports.hex = "FFF65B";
exports.categories = ["Booking"];
exports.aliases = [];
exports.svg = `<svg role="img" aria-label="Lodgify" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <title>Lodgify</title>
...
exports.url = "https://www.lodgify.com";

...
export const slug = "qt";
export const title = "Qt";
export const hex = "41CD52";
...
export const url = "https://www.qt.io/";

const qt = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default qt;

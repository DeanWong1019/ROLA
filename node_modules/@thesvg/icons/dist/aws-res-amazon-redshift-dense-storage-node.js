// @thesvg/icons - Amazon Redshift Dense Storage Node
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-redshift-dense-storage-node";
export const title = "Amazon Redshift Dense Storage Node";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Dense Storage Node"];
...
const aws_res_amazon_redshift_dense_storage_node = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_redshift_dense_storage_node;

// @thesvg/icons - Amazon DynamoDB Standard Infrequent Access Table Class
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-standard-infrequent-access-table-class";
export const title = "Amazon DynamoDB Standard Infrequent Access Table Class";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Standard Infrequent Access Table Class"];
...
const aws_res_amazon_dynamodb_standard_infrequent_access_table_class = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_standard_infrequent_access_table_class;

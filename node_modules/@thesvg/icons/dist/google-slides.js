// @thesvg/icons - Google Slides
// Auto-generated. Do not edit.

export const slug = "google-slides";
export const title = "Google Slides";
export const hex = "FBBC04";
export const categories = ["Google", "Software"];
export const aliases = [];
export const svg = `<svg width="73" height="100" viewBox="0 0 73 100" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const variants = {
  "default": `<svg width="73" height="100" viewBox="0 0 73 100" fill="none" xmlns="http://www.w3.org/2000/svg">
<mask id="mask0_1:2" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="72" height="99">
<path d="M44.8232 0H6.72348C3.02557 0 0 3.02557 0 6.72348V91.8876C0 95.5855 3.02557 98.6111 6.72348 98.6111H64.9937C68.6916 98.6111 71.7172 95.5855 71.7172 91.8876V26.8939L44.8232 0Z" fill="white"/>
</mask>
<g mask="url(#mask0_1:2)">
...
<stop offset="1" stop-color="white" stop-opacity="0"/>
  ...
  "mono": `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Google Slides</title><path d="M16.09 15.273H7.91v-4.637h8.18v4.637zm1.728-8.523h2.91v15.614c0 .904-.733 1.636-1.637 1.636H4.909a1.636 1.636 0 0 1-1.636-1.636V1.636C3.273.732 4.005 0 4.909 0h9.068v6.75h3.841zm-.363 2.523H6.545v7.363h10.91V9.273zm-2.728-5.979V6h6.001l-6-6v3.294z"/></svg>`
};
export const license = "CC0-1.0";
export const url = "https://slides.google.com/";

const google_slides = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default google_slides;

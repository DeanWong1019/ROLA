// @thesvg/icons - AWS Identity Access Management IAM Roles Anywhere
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-iam-roles-anywhere";
export const title = "AWS Identity Access Management IAM Roles Anywhere";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["IAM Roles Anywhere"];
...
const aws_res_aws_identity_access_management_iam_roles_anywhere = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_iam_roles_anywhere;

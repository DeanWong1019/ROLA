// @thesvg/icons - AWS Trusted Advisor Checklist Cost
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-trusted-advisor-checklist-cost";
export const title = "AWS Trusted Advisor Checklist Cost";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Checklist Cost"];
...
const aws_res_aws_trusted_advisor_checklist_cost = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_trusted_advisor_checklist_cost;

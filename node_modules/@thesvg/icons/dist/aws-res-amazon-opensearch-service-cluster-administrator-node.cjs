...
exports.slug = "aws-res-amazon-opensearch-service-cluster-administrator-node";
exports.title = "Amazon OpenSearch Service Cluster Administrator Node";
exports.hex = "8C4FFF";
exports.categories = ["Analytics"];
exports.aliases = ["Cluster Administrator Node"];

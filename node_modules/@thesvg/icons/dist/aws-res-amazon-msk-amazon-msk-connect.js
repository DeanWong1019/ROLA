// @thesvg/icons - Amazon MSK Amazon MSK Connect
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-msk-amazon-msk-connect";
export const title = "Amazon MSK Amazon MSK Connect";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Amazon MSK Connect"];
...
const aws_res_amazon_msk_amazon_msk_connect = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_msk_amazon_msk_connect;

// @thesvg/icons - SiliconCloud (SiliconFlow)
// Auto-generated. Do not edit.

export const slug = "siliconcloud-siliconflow";
export const title = "SiliconCloud (SiliconFlow)";
export const hex = "6E29F6";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>SiliconCloud (SiliconFlow)</title>
...
export const url = "https://siliconflow.com";

const siliconcloud_siliconflow = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default siliconcloud_siliconflow;

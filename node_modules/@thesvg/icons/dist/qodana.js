...
export const slug = "qodana";
export const title = "Qodana";
export const hex = "FF318C";
...
const qodana = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default qodana;

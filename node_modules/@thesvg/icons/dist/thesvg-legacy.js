// @thesvg/icons - theSVG (legacy)
// Auto-generated. Do not edit.

export const slug = "thesvg-legacy";
export const title = "theSVG (legacy)";
export const hex = "F97316";
export const categories = ["Design", "Devtool"];
export const aliases = ["thesvg original", "thesvg 2026-Q1"];
...
export const variants = {
  ...
  "dark": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="none">
...
export const url = "https://thesvg.org";

const thesvg_legacy = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default thesvg_legacy;

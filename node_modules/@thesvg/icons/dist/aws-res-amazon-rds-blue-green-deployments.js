// @thesvg/icons - Amazon RDS Blue Green Deployments
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-rds-blue-green-deployments";
export const title = "Amazon RDS Blue Green Deployments";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Blue Green Deployments"];
...
const aws_res_amazon_rds_blue_green_deployments = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_rds_blue_green_deployments;

// @thesvg/icons - AWS IoT Thing_Factory
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-factory";
export const title = "AWS IoT Thing_Factory";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Factory"];
...
const aws_res_aws_iot_thing_factory = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_factory;

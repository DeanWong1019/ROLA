...
export const slug = "ebay";
export const title = "eBay";
export const hex = "E53238";
export const categories = ["Shopping", "Platform"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox=".1 .1 299.8 120.125">

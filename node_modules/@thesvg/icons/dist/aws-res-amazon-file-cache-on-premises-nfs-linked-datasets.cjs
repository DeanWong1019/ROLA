...
exports.slug = "aws-res-amazon-file-cache-on-premises-nfs-linked-datasets";
exports.title = "Amazon File Cache On premises NFS linked datasets";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["On premises NFS linked datasets"];

// @thesvg/icons - AWS Mainframe Modernization Analyzer
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-mainframe-modernization-analyzer";
export const title = "AWS Mainframe Modernization Analyzer";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Analyzer"];
...
const aws_res_aws_mainframe_modernization_analyzer = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_mainframe_modernization_analyzer;

// @thesvg/icons - Amazon Elastic File System EFS Intelligent Tiering
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-file-system-efs-intelligent-tiering";
export const title = "Amazon Elastic File System EFS Intelligent Tiering";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["EFS Intelligent Tiering"];
...
const aws_res_amazon_elastic_file_system_efs_intelligent_tiering = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_file_system_efs_intelligent_tiering;

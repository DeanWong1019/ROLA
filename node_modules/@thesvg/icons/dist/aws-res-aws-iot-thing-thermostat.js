// @thesvg/icons - AWS IoT Thing_Thermostat
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-thermostat";
export const title = "AWS IoT Thing_Thermostat";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Thermostat"];
...
const aws_res_aws_iot_thing_thermostat = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_thermostat;

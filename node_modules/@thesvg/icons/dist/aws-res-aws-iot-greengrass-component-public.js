// @thesvg/icons - AWS IoT Greengrass Component Public
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-greengrass-component-public";
export const title = "AWS IoT Greengrass Component Public";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Component Public"];
...
const aws_res_aws_iot_greengrass_component_public = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_greengrass_component_public;

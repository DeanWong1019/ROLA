// @thesvg/icons - AWS Application Discovery Service AWS Agentless Collector
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-application-discovery-service-aws-agentless-collector";
export const title = "AWS Application Discovery Service AWS Agentless Collector";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["AWS Agentless Collector"];
...
const aws_res_aws_application_discovery_service_aws_agentless_collector = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_application_discovery_service_aws_agentless_collector;

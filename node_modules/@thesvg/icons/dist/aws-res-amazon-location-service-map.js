// @thesvg/icons - Amazon Location Service Map 
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-location-service-map";
export const title = "Amazon Location Service Map ";
export const hex = "C7131F";
export const categories = ["Frontend"];
export const aliases = ["Map "];
...
const aws_res_amazon_location_service_map = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_location_service_map;

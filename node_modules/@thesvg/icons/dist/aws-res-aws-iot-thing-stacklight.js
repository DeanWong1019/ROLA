// @thesvg/icons - AWS IoT Thing_Stacklight
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-stacklight";
export const title = "AWS IoT Thing_Stacklight";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Stacklight"];
...
const aws_res_aws_iot_thing_stacklight = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_stacklight;

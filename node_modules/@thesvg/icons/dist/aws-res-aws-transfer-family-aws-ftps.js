// @thesvg/icons - AWS Transfer Family AWS FTPS
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-transfer-family-aws-ftps";
export const title = "AWS Transfer Family AWS FTPS";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["AWS FTPS"];
...
const aws_res_aws_transfer_family_aws_ftps = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_transfer_family_aws_ftps;

// @thesvg/icons - Charles Schwab
// Auto-generated. Do not edit.

export const slug = "charles-schwab";
export const title = "Charles Schwab";
export const hex = "00A0DF";
export const categories = ["Finance", "Software"];
export const aliases = ["Schwab"];
...
export const url = "https://www.schwab.com";

const charles_schwab = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default charles_schwab;

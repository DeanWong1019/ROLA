// @thesvg/icons - Amazon DocumentDB Elastic Clusters
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-documentdb-elastic-clusters";
export const title = "Amazon DocumentDB Elastic Clusters";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Elastic Clusters"];
...
const aws_res_amazon_documentdb_elastic_clusters = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_documentdb_elastic_clusters;

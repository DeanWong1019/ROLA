// @thesvg/icons - AWS Snowball Snowball Import Export
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-snowball-snowball-import-export";
export const title = "AWS Snowball Snowball Import Export";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Snowball Import Export"];
...
const aws_res_aws_snowball_snowball_import_export = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_snowball_snowball_import_export;

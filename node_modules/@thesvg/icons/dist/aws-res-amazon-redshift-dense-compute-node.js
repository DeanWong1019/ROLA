// @thesvg/icons - Amazon Redshift Dense Compute Node
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-redshift-dense-compute-node";
export const title = "Amazon Redshift Dense Compute Node";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Dense Compute Node"];
...
const aws_res_amazon_redshift_dense_compute_node = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_redshift_dense_compute_node;

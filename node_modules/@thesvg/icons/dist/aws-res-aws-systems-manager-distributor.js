// @thesvg/icons - AWS Systems Manager Distributor
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-distributor";
export const title = "AWS Systems Manager Distributor";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Distributor"];
...
const aws_res_aws_systems_manager_distributor = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_distributor;

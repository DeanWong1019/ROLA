// @thesvg/icons - Amazon Simple Notification Service Topic
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-notification-service-topic";
export const title = "Amazon Simple Notification Service Topic";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Topic"];
...
const aws_res_amazon_simple_notification_service_topic = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_notification_service_topic;

// @thesvg/icons - Amazon Textract Analyze Lending
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-textract-analyze-lending";
export const title = "Amazon Textract Analyze Lending";
export const hex = "01A88D";
export const categories = ["AI"];
export const aliases = ["Analyze Lending"];
...
const aws_res_amazon_textract_analyze_lending = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_textract_analyze_lending;

// @thesvg/icons - Amazon EC2 Instances
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-ec2-instances";
export const title = "Amazon EC2 Instances";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["Instances"];
...
const aws_res_amazon_ec2_instances = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_ec2_instances;

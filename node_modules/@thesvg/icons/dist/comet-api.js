// @thesvg/icons - Comet API
// Auto-generated. Do not edit.

export const slug = "comet-api";
export const title = "Comet API";
export const hex = "00ACE2";
...
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  <path d="M16.293 4.799a3.09 3.09 0 01.852 4.44c-.961 1.318-2.428.3-3.421-.321-.993-.62-2.555-1.488-1.794-2.931a3.09 3.09 0 014.363-1.188z"
        fill="#fff" />
</svg>`;
...
export const url = "https://cometapi.com/";

const comet_api = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default comet_api;

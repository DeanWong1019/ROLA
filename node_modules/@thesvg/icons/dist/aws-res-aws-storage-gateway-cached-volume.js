// @thesvg/icons - AWS Storage Gateway Cached Volume
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-storage-gateway-cached-volume";
export const title = "AWS Storage Gateway Cached Volume";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Cached Volume"];
...
const aws_res_aws_storage_gateway_cached_volume = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_storage_gateway_cached_volume;

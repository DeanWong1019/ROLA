// @thesvg/icons - Amazon Location Service Routes
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-location-service-routes";
export const title = "Amazon Location Service Routes";
export const hex = "C7131F";
export const categories = ["Frontend"];
export const aliases = ["Routes"];
...
const aws_res_amazon_location_service_routes = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_location_service_routes;

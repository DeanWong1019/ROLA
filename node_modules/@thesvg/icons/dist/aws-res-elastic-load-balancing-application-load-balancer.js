// @thesvg/icons - Elastic Load Balancing Application Load Balancer
// Auto-generated. Do not edit.

export const slug = "aws-res-elastic-load-balancing-application-load-balancer";
export const title = "Elastic Load Balancing Application Load Balancer";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Application Load Balancer"];
...
const aws_res_elastic_load_balancing_application_load_balancer = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_elastic_load_balancing_application_load_balancer;

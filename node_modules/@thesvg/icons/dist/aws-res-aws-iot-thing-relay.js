// @thesvg/icons - AWS IoT Thing_Relay
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-relay";
export const title = "AWS IoT Thing_Relay";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Relay"];
...
const aws_res_aws_iot_thing_relay = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_relay;

// @thesvg/icons - Amazon Braket Simulator 4
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-braket-simulator-4";
export const title = "Amazon Braket Simulator 4";
export const hex = "ED7100";
export const categories = ["Quantum"];
export const aliases = ["Simulator 4"];
...
const aws_res_amazon_braket_simulator_4 = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_braket_simulator_4;

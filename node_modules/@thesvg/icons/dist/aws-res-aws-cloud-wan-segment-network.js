// @thesvg/icons - AWS Cloud WAN Segment Network
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloud-wan-segment-network";
export const title = "AWS Cloud WAN Segment Network";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Segment Network"];
...
const aws_res_aws_cloud_wan_segment_network = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloud_wan_segment_network;

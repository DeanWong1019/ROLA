// @thesvg/icons - AWS Systems Manager Application Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-application-manager";
export const title = "AWS Systems Manager Application Manager";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Application Manager"];
...
const aws_res_aws_systems_manager_application_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_application_manager;

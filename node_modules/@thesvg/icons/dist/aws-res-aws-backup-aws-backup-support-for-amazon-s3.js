// @thesvg/icons - AWS Backup AWS Backup support for Amazon S3
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-aws-backup-support-for-amazon-s3";
export const title = "AWS Backup AWS Backup support for Amazon S3";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["AWS Backup support for Amazon S3"];
...
const aws_res_aws_backup_aws_backup_support_for_amazon_s3 = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_aws_backup_support_for_amazon_s3;

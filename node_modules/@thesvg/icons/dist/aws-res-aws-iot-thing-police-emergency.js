// @thesvg/icons - AWS IoT Thing_Police Emergency
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-police-emergency";
export const title = "AWS IoT Thing_Police Emergency";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Police Emergency"];
...
const aws_res_aws_iot_thing_police_emergency = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_police_emergency;

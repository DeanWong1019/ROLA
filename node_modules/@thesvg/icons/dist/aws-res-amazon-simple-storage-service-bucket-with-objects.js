// @thesvg/icons - Amazon Simple Storage Service Bucket With Objects
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-bucket-with-objects";
export const title = "Amazon Simple Storage Service Bucket With Objects";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Bucket With Objects"];
...
const aws_res_amazon_simple_storage_service_bucket_with_objects = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_bucket_with_objects;

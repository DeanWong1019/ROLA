// @thesvg/icons - AWS Glue Crawler
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-glue-crawler";
export const title = "AWS Glue Crawler";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Crawler"];
...
const aws_res_aws_glue_crawler = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_glue_crawler;

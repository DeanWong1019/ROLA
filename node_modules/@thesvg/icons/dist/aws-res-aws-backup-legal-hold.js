// @thesvg/icons - AWS Backup Legal Hold
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-legal-hold";
export const title = "AWS Backup Legal Hold";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Legal Hold"];
...
const aws_res_aws_backup_legal_hold = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_legal_hold;

// @thesvg/icons - AWS Transfer Family AWS SFTP
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-transfer-family-aws-sftp";
export const title = "AWS Transfer Family AWS SFTP";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["AWS SFTP"];
...
const aws_res_aws_transfer_family_aws_sftp = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_transfer_family_aws_sftp;

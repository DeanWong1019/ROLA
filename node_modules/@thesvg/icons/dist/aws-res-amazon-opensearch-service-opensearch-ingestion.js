// @thesvg/icons - Amazon OpenSearch Service OpenSearch Ingestion
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-opensearch-service-opensearch-ingestion";
export const title = "Amazon OpenSearch Service OpenSearch Ingestion";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["OpenSearch Ingestion"];
...
const aws_res_amazon_opensearch_service_opensearch_ingestion = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_opensearch_service_opensearch_ingestion;

// @thesvg/icons - AWS IoT SiteWise Asset
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-sitewise-asset";
export const title = "AWS IoT SiteWise Asset";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Asset"];
...
const aws_res_aws_iot_sitewise_asset = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_sitewise_asset;

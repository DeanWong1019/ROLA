// @thesvg/icons - Amazon Elastic Block Store Amazon Data Lifecycle Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-block-store-amazon-data-lifecycle-manager";
export const title = "Amazon Elastic Block Store Amazon Data Lifecycle Manager";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Amazon Data Lifecycle Manager"];
...
const aws_res_amazon_elastic_block_store_amazon_data_lifecycle_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_block_store_amazon_data_lifecycle_manager;

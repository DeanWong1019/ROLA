...
exports.slug = "aws-res-amazon-simple-storage-service-s3-replication-time-control";
exports.title = "Amazon Simple Storage Service S3 Replication Time Control";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["S3 Replication Time Control"];

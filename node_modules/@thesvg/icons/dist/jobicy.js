...
export const slug = "jobicy";
export const title = "Jobicy";
export const hex = "029AEB";
export const categories = ["Services", "Business", "HR"];
export const aliases = [];
export const svg = `<svg width="587" height="587" viewBox="0 0 587 587" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const url = "https://jobicy.com";

const jobicy = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - Amazon Redshift Data Sharing Governance
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-redshift-data-sharing-governance";
export const title = "Amazon Redshift Data Sharing Governance";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Data Sharing Governance"];
...
const aws_res_amazon_redshift_data_sharing_governance = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_redshift_data_sharing_governance;

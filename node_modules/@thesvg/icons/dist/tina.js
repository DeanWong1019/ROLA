...
export const slug = "tina";
export const title = "Tina";
export const hex = "EC4815";
export const categories = ["CMS", "Software"];
export const aliases = [];
export const svg = `<svg width="448" height="621" viewBox="0 0 448 621" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const url = "https://tina.io/";

const tina = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default tina;

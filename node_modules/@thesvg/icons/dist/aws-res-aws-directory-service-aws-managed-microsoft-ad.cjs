...
exports.slug = "aws-res-aws-directory-service-aws-managed-microsoft-ad";
exports.title = "AWS Directory Service AWS Managed Microsoft AD";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["AWS Managed Microsoft AD"];

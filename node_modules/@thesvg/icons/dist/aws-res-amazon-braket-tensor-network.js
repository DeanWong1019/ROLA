// @thesvg/icons - Amazon Braket Tensor Network
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-braket-tensor-network";
export const title = "Amazon Braket Tensor Network";
export const hex = "ED7100";
export const categories = ["Quantum"];
export const aliases = ["Tensor Network"];
...
const aws_res_amazon_braket_tensor_network = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_braket_tensor_network;

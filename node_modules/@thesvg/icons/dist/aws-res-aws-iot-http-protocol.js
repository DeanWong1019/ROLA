// @thesvg/icons - AWS IoT HTTP_Protocol
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-http-protocol";
export const title = "AWS IoT HTTP_Protocol";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["HTTP_Protocol"];
...
const aws_res_aws_iot_http_protocol = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_http_protocol;

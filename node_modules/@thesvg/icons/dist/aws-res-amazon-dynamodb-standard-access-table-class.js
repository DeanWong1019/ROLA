// @thesvg/icons - Amazon DynamoDB Standard Access Table Class
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-standard-access-table-class";
export const title = "Amazon DynamoDB Standard Access Table Class";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Standard Access Table Class"];
...
const aws_res_amazon_dynamodb_standard_access_table_class = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_standard_access_table_class;

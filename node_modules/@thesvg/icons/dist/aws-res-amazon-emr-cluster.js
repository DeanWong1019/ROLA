// @thesvg/icons - Amazon EMR Cluster
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-emr-cluster";
export const title = "Amazon EMR Cluster";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Cluster"];
...
const aws_res_amazon_emr_cluster = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_emr_cluster;

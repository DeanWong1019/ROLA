// @thesvg/icons - AWS IoT Sensor
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-sensor";
export const title = "AWS IoT Sensor";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Sensor"];
...
const aws_res_aws_iot_sensor = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_sensor;

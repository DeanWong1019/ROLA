// @thesvg/icons - Amazon EC2 AMI
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-ec2-ami";
export const title = "Amazon EC2 AMI";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["AMI"];
...
const aws_res_amazon_ec2_ami = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_ec2_ami;

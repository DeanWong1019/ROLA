// @thesvg/icons - AWS Identity Access Management Temporary Security Credential
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-temporary-security-credential";
export const title = "AWS Identity Access Management Temporary Security Credential";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Temporary Security Credential"];
...
const aws_res_aws_identity_access_management_temporary_security_credential = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_temporary_security_credential;

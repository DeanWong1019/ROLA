...
exports.slug = "aws-res-aws-storage-gateway-amazon-fsx-file-gateway";
exports.title = "AWS Storage Gateway Amazon FSx File Gateway";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["Amazon FSx File Gateway"];

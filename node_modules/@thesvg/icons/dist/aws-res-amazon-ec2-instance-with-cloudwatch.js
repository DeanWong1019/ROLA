// @thesvg/icons - Amazon EC2 Instance with CloudWatch
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-ec2-instance-with-cloudwatch";
export const title = "Amazon EC2 Instance with CloudWatch";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["Instance with CloudWatch"];
...
const aws_res_amazon_ec2_instance_with_cloudwatch = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_ec2_instance_with_cloudwatch;

// @thesvg/icons - AWS CloudFormation Stack
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloudformation-stack";
export const title = "AWS CloudFormation Stack";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Stack"];
...
const aws_res_aws_cloudformation_stack = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloudformation_stack;

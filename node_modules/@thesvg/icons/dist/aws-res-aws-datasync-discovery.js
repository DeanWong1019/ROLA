// @thesvg/icons - AWS DataSync Discovery
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-datasync-discovery";
export const title = "AWS DataSync Discovery";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Discovery"];
...
const aws_res_aws_datasync_discovery = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_datasync_discovery;

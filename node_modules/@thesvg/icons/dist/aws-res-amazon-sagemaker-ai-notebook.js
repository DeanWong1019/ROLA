// @thesvg/icons - Amazon SageMaker AI Notebook
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-sagemaker-ai-notebook";
export const title = "Amazon SageMaker AI Notebook";
export const hex = "01A88D";
export const categories = ["AI"];
export const aliases = ["Notebook"];
...
const aws_res_amazon_sagemaker_ai_notebook = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_sagemaker_ai_notebook;

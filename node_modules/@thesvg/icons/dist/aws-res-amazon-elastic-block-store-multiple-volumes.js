// @thesvg/icons - Amazon Elastic Block Store Multiple Volumes
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-block-store-multiple-volumes";
export const title = "Amazon Elastic Block Store Multiple Volumes";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Multiple Volumes"];
...
const aws_res_amazon_elastic_block_store_multiple_volumes = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_block_store_multiple_volumes;

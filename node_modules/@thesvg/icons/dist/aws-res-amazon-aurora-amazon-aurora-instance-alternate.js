// @thesvg/icons - Amazon Aurora Amazon Aurora Instance alternate
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-aurora-amazon-aurora-instance-alternate";
export const title = "Amazon Aurora Amazon Aurora Instance alternate";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Amazon Aurora Instance alternate"];
...
const aws_res_amazon_aurora_amazon_aurora_instance_alternate = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_aurora_amazon_aurora_instance_alternate;

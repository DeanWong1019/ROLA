// @thesvg/icons - Amazon RDS Multi AZ DB Cluster
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-rds-multi-az-db-cluster";
export const title = "Amazon RDS Multi AZ DB Cluster";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Multi AZ DB Cluster"];
...
const aws_res_amazon_rds_multi_az_db_cluster = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_rds_multi_az_db_cluster;

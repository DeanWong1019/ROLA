// @thesvg/icons - Amazon SageMaker AI Train
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-sagemaker-ai-train";
export const title = "Amazon SageMaker AI Train";
export const hex = "01A88D";
export const categories = ["AI"];
export const aliases = ["Train"];
...
const aws_res_amazon_sagemaker_ai_train = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_sagemaker_ai_train;

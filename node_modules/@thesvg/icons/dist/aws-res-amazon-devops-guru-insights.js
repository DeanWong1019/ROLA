// @thesvg/icons - Amazon DevOps Guru Insights
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-devops-guru-insights";
export const title = "Amazon DevOps Guru Insights";
export const hex = "01A88D";
export const categories = ["AI"];
export const aliases = ["Insights"];
...
const aws_res_amazon_devops_guru_insights = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_devops_guru_insights;

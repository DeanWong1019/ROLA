...
exports.slug = "aws-res-amazon-dynamodb-amazon-dynamodb-accelerator";
exports.title = "Amazon DynamoDB Amazon DynamoDB Accelerator";
exports.hex = "527FFF";
exports.categories = ["Database"];
exports.aliases = ["Amazon DynamoDB Accelerator"];

// @thesvg/icons - AWS CloudFormation Change Set
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloudformation-change-set";
export const title = "AWS CloudFormation Change Set";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Change Set"];
...
const aws_res_aws_cloudformation_change_set = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloudformation_change_set;

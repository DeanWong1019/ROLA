...
exports.slug = "aws-res-aws-backup-aws-backup-support-for-amazon-s3";
exports.title = "AWS Backup AWS Backup support for Amazon S3";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["AWS Backup support for Amazon S3"];

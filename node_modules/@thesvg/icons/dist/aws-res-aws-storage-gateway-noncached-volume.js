// @thesvg/icons - AWS Storage Gateway Noncached Volume
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-storage-gateway-noncached-volume";
export const title = "AWS Storage Gateway Noncached Volume";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Noncached Volume"];
...
const aws_res_aws_storage_gateway_noncached_volume = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_storage_gateway_noncached_volume;

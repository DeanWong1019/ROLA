// @thesvg/icons - AWS WAF Bot Control
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-waf-bot-control";
export const title = "AWS WAF Bot Control";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Bot Control"];
...
const aws_res_aws_waf_bot_control = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_waf_bot_control;

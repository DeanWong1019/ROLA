// @thesvg/icons - AWS IoT Thing_Coffee Pot
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-coffee-pot";
export const title = "AWS IoT Thing_Coffee Pot";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Coffee Pot"];
...
const aws_res_aws_iot_thing_coffee_pot = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_coffee_pot;

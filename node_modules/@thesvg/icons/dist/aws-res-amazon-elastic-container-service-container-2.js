// @thesvg/icons - Amazon Elastic Container Service Container 2
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-container-service-container-2";
export const title = "Amazon Elastic Container Service Container 2";
export const hex = "ED7100";
export const categories = ["Containers"];
export const aliases = ["Container 2"];
...
const aws_res_amazon_elastic_container_service_container_2 = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_container_service_container_2;

...
exports.slug = "aws-res-amazon-elasticache-elasticache-for-redis";
exports.title = "Amazon ElastiCache ElastiCache for Redis";
exports.hex = "527FFF";
exports.categories = ["Database"];
exports.aliases = ["ElastiCache for Redis"];

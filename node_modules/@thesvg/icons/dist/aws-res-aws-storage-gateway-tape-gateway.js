// @thesvg/icons - AWS Storage Gateway Tape Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-storage-gateway-tape-gateway";
export const title = "AWS Storage Gateway Tape Gateway";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Tape Gateway"];
...
const aws_res_aws_storage_gateway_tape_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_storage_gateway_tape_gateway;

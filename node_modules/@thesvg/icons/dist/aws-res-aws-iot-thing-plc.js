// @thesvg/icons - AWS IoT Thing_PLC
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-plc";
export const title = "AWS IoT Thing_PLC";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_PLC"];
...
const aws_res_aws_iot_thing_plc = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_plc;

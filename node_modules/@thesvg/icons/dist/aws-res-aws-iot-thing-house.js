// @thesvg/icons - AWS IoT Thing_House
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-house";
export const title = "AWS IoT Thing_House";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_House"];
...
const aws_res_aws_iot_thing_house = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_house;

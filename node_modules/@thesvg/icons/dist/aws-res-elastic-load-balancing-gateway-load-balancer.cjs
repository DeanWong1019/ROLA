...
exports.slug = "aws-res-elastic-load-balancing-gateway-load-balancer";
exports.title = "Elastic Load Balancing Gateway Load Balancer";
exports.hex = "8C4FFF";
exports.categories = ["Networking"];
exports.aliases = ["Gateway Load Balancer"];

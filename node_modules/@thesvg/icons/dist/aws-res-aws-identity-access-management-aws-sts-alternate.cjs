...
exports.slug = "aws-res-aws-identity-access-management-aws-sts-alternate";
exports.title = "AWS Identity Access Management AWS STS Alternate";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["AWS STS Alternate"];

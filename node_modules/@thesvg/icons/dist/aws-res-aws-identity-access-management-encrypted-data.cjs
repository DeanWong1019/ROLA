...
exports.slug = "aws-res-aws-identity-access-management-encrypted-data";
exports.title = "AWS Identity Access Management Encrypted Data";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["Encrypted Data"];

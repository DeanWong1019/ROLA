// @thesvg/icons - AWS Identity Access Management Data Encryption Key
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-data-encryption-key";
export const title = "AWS Identity Access Management Data Encryption Key";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Data Encryption Key"];
...
const aws_res_aws_identity_access_management_data_encryption_key = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_data_encryption_key;

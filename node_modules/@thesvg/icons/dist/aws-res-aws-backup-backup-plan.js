// @thesvg/icons - AWS Backup Backup Plan
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-backup-plan";
export const title = "AWS Backup Backup Plan";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Backup Plan"];
...
const aws_res_aws_backup_backup_plan = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_backup_plan;

...
exports.slug = "aws-res-amazon-file-cache-hybrid-nfs-linked-datasets";
exports.title = "Amazon File Cache Hybrid NFS linked datasets";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["Hybrid NFS linked datasets"];

// @thesvg/icons - AWS Backup Recovery Point Objective
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-recovery-point-objective";
export const title = "AWS Backup Recovery Point Objective";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Recovery Point Objective"];
...
const aws_res_aws_backup_recovery_point_objective = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_recovery_point_objective;

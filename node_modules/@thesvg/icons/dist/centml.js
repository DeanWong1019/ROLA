...
export const slug = "centml";
export const title = "CentML";
export const hex = "004331";
...
export const url = "https://centml.ai";

const centml = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default centml;

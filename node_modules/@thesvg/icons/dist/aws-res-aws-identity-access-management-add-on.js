// @thesvg/icons - AWS Identity Access Management Add on
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-add-on";
export const title = "AWS Identity Access Management Add on";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Add on"];
...
const aws_res_aws_identity_access_management_add_on = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_add_on;

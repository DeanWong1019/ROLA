// @thesvg/icons - AWS Backup Virtual Machine
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-virtual-machine";
export const title = "AWS Backup Virtual Machine";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Virtual Machine"];
...
const aws_res_aws_backup_virtual_machine = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_virtual_machine;

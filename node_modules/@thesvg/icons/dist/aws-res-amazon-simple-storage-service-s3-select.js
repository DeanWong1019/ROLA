// @thesvg/icons - Amazon Simple Storage Service S3 Select
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-s3-select";
export const title = "Amazon Simple Storage Service S3 Select";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["S3 Select"];
...
const aws_res_amazon_simple_storage_service_s3_select = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_s3_select;

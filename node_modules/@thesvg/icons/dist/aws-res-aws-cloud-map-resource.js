// @thesvg/icons - AWS Cloud Map Resource
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloud-map-resource";
export const title = "AWS Cloud Map Resource";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Resource"];
...
const aws_res_aws_cloud_map_resource = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloud_map_resource;

// @thesvg/icons - Amazon Simple Queue Service Queue
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-queue-service-queue";
export const title = "Amazon Simple Queue Service Queue";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Queue"];
...
const aws_res_amazon_simple_queue_service_queue = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_queue_service_queue;

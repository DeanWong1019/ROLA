// @thesvg/icons - Zhipu (智谱)
// Auto-generated. Do not edit.

export const slug = "zhipu";
export const title = "Zhipu (智谱)";
export const hex = "3859FF";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>Zhipu (智谱)</title>
...
export const url = "https://zhipuai.cn";

const zhipu = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - AWS IoT Over Air Update
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-over-air-update";
export const title = "AWS IoT Over Air Update";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Over Air Update"];
...
const aws_res_aws_iot_over_air_update = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_over_air_update;

...
export const slug = "github";
export const title = "GitHub";
export const hex = "181717";
export const categories = ["Devtool", "Software"];
export const aliases = [];
export const svg = `<svg viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const github = { slug, title, hex, categories, aliases, svg, variants, license, url };

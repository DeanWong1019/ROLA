// @thesvg/icons - AWS Shield AWS Shield Advanced
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-shield-aws-shield-advanced";
export const title = "AWS Shield AWS Shield Advanced";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["AWS Shield Advanced"];
...
const aws_res_aws_shield_aws_shield_advanced = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_shield_aws_shield_advanced;

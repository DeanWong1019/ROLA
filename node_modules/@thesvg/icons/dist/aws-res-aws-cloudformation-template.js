// @thesvg/icons - AWS CloudFormation Template
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloudformation-template";
export const title = "AWS CloudFormation Template";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Template"];
...
const aws_res_aws_cloudformation_template = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloudformation_template;

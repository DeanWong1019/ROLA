// @thesvg/icons - AWS Glue Data Quality
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-glue-data-quality";
export const title = "AWS Glue Data Quality";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Data Quality"];
...
const aws_res_aws_glue_data_quality = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_glue_data_quality;

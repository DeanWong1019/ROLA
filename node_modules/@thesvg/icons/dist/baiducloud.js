// @thesvg/icons - BaiduCloud (百度智能云)
// Auto-generated. Do not edit.

export const slug = "baiducloud";
export const title = "BaiduCloud (百度智能云)";
export const hex = "2468f2";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>BaiduCloud (百度智能云)</title>
...
export const url = "https://cloud.baidu.com";

const baiducloud = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default baiducloud;

// @thesvg/icons - AWS IoT Actuator
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-actuator";
export const title = "AWS IoT Actuator";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Actuator"];
...
const aws_res_aws_iot_actuator = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_actuator;

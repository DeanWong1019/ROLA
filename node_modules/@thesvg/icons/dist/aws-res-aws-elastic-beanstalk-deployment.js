// @thesvg/icons - AWS Elastic Beanstalk Deployment
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-elastic-beanstalk-deployment";
export const title = "AWS Elastic Beanstalk Deployment";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["Deployment"];
...
const aws_res_aws_elastic_beanstalk_deployment = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_elastic_beanstalk_deployment;

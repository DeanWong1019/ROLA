// @thesvg/icons - Amazon SageMaker AI Model
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-sagemaker-ai-model";
export const title = "Amazon SageMaker AI Model";
export const hex = "01A88D";
export const categories = ["AI"];
export const aliases = ["Model"];
...
const aws_res_amazon_sagemaker_ai_model = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_sagemaker_ai_model;

// @thesvg/icons - Amazon OpenSearch Service Index
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-opensearch-service-index";
export const title = "Amazon OpenSearch Service Index";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Index"];
...
const aws_res_amazon_opensearch_service_index = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_opensearch_service_index;

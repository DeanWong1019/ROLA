// @thesvg/icons - AWS App Mesh Virtual Node
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-app-mesh-virtual-node";
export const title = "AWS App Mesh Virtual Node";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Virtual Node"];
...
const aws_res_aws_app_mesh_virtual_node = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_app_mesh_virtual_node;

// @thesvg/icons - Amazon VPC Elastic Network Interface
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-elastic-network-interface";
export const title = "Amazon VPC Elastic Network Interface";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Elastic Network Interface"];
...
const aws_res_amazon_vpc_elastic_network_interface = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_elastic_network_interface;

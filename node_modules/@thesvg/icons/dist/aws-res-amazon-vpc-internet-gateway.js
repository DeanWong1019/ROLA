// @thesvg/icons - Amazon VPC Internet Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-internet-gateway";
export const title = "Amazon VPC Internet Gateway";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Internet Gateway"];
...
const aws_res_amazon_vpc_internet_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_internet_gateway;

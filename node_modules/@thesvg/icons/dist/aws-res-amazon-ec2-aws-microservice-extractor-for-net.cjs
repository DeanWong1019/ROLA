...
exports.slug = "aws-res-amazon-ec2-aws-microservice-extractor-for-net";
exports.title = "Amazon EC2 AWS Microservice Extractor for .NET";
exports.hex = "ED7100";
exports.categories = ["Compute"];
exports.aliases = ["AWS Microservice Extractor for .NET"];

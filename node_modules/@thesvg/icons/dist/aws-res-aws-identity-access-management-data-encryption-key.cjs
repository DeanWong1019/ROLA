...
exports.slug = "aws-res-aws-identity-access-management-data-encryption-key";
exports.title = "AWS Identity Access Management Data Encryption Key";
exports.hex = "DD344C";
exports.categories = ["Security"];
exports.aliases = ["Data Encryption Key"];

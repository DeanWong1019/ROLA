// @thesvg/icons - Amazon VPC Carrier Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-carrier-gateway";
export const title = "Amazon VPC Carrier Gateway";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Carrier Gateway"];
...
const aws_res_amazon_vpc_carrier_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_carrier_gateway;

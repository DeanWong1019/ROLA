// @thesvg/icons - Amazon VPC Reachability Analyzer
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-reachability-analyzer";
export const title = "Amazon VPC Reachability Analyzer";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Reachability Analyzer"];
...
const aws_res_amazon_vpc_reachability_analyzer = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_reachability_analyzer;

// @thesvg/icons - AWS IoT Certificate
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-certificate";
export const title = "AWS IoT Certificate";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Certificate"];
...
const aws_res_aws_iot_certificate = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_certificate;

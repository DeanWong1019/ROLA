// @thesvg/icons - AWS Transfer Family AWS AS2
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-transfer-family-aws-as2";
export const title = "AWS Transfer Family AWS AS2";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["AWS AS2"];
...
const aws_res_aws_transfer_family_aws_as2 = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_transfer_family_aws_as2;

// @thesvg/icons - Amazon DynamoDB Attribute
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-attribute";
export const title = "Amazon DynamoDB Attribute";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Attribute"];
...
const aws_res_amazon_dynamodb_attribute = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_attribute;

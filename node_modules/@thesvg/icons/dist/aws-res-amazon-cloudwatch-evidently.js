// @thesvg/icons - Amazon CloudWatch Evidently
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-evidently";
export const title = "Amazon CloudWatch Evidently";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Evidently"];
...
const aws_res_amazon_cloudwatch_evidently = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_evidently;

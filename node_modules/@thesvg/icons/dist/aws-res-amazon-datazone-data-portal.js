// @thesvg/icons - Amazon DataZone Data Portal
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-datazone-data-portal";
export const title = "Amazon DataZone Data Portal";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Data Portal"];
...
const aws_res_amazon_datazone_data_portal = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_datazone_data_portal;

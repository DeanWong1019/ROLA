// @thesvg/icons - AWS WAF Bad Bot
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-waf-bad-bot";
export const title = "AWS WAF Bad Bot";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Bad Bot"];
...
const aws_res_aws_waf_bad_bot = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_waf_bad_bot;

...
export const slug = "302dotai";
export const title = "302.AI";
export const hex = "8E47FF";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>302.AI</title>
  <path d="M13.086 23.25c5.614 0 10.164-4.559 10.164-10.182 0-5.624-4.55-10.182-10.164-10.182-5.613 0-10.163 4.558-10.163 10.182 0 5.623 4.55 10.182 10.163 10.182z"
        fill="#3F3FAA" />
  <path d="M10.914 21.114c5.613 0 10.163-4.559 10.163-10.182S16.527.75 10.914.75C5.3.75.75 5.309.75 10.932S5.3 21.114 10.914 21.114z"
        fill="#8E47FF" />
...
export const variants = {
  ...
  <title>302.AI</title>
  <path d="M19.04 4.818a10.171 10.171 0 014.21 8.25c0 5.623-4.55 10.182-10.163 10.182a10.142 10.142 0 01-8.129-4.07 10.102 10.102 0 005.956 1.934c5.613 0 10.163-4.56 10.163-10.182 0-2.295-.759-4.411-2.037-6.114z"
        fill-opacity=".5" />
...
export const url = "https://302.ai/";

const i_302dotai = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default i_302dotai;

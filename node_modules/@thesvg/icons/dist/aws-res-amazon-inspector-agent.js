// @thesvg/icons - Amazon Inspector Agent
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-inspector-agent";
export const title = "Amazon Inspector Agent";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["Agent"];
...
const aws_res_amazon_inspector_agent = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_inspector_agent;

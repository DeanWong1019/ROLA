// @thesvg/icons - AWS Mainframe Modernization Runtime
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-mainframe-modernization-runtime";
export const title = "AWS Mainframe Modernization Runtime";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["Runtime"];
...
const aws_res_aws_mainframe_modernization_runtime = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_mainframe_modernization_runtime;

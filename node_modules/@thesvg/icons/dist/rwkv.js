...
export const slug = "rwkv";
export const title = "RWKV";
export const hex = "3431C3";
...
export const url = "https://github.com/RWKV";

const rwkv = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default rwkv;

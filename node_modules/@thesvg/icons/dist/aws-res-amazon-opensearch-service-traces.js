// @thesvg/icons - Amazon OpenSearch Service Traces
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-opensearch-service-traces";
export const title = "Amazon OpenSearch Service Traces";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Traces"];
...
const aws_res_amazon_opensearch_service_traces = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_opensearch_service_traces;

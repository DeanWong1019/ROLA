...
exports.slug = "aws-res-amazon-opensearch-service-opensearch-ingestion";
exports.title = "Amazon OpenSearch Service OpenSearch Ingestion";
exports.hex = "8C4FFF";
exports.categories = ["Analytics"];
exports.aliases = ["OpenSearch Ingestion"];

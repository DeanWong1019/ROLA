// @thesvg/icons - Amazon Elastic File System EFS Standard
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-file-system-efs-standard";
export const title = "Amazon Elastic File System EFS Standard";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["EFS Standard"];
...
const aws_res_amazon_elastic_file_system_efs_standard = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_file_system_efs_standard;

// @thesvg/icons - AWS Identity Access Management AWS STS Alternate
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-identity-access-management-aws-sts-alternate";
export const title = "AWS Identity Access Management AWS STS Alternate";
export const hex = "DD344C";
export const categories = ["Security"];
export const aliases = ["AWS STS Alternate"];
...
const aws_res_aws_identity_access_management_aws_sts_alternate = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_identity_access_management_aws_sts_alternate;

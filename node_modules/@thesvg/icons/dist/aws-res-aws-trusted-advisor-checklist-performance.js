// @thesvg/icons - AWS Trusted Advisor Checklist Performance
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-trusted-advisor-checklist-performance";
export const title = "AWS Trusted Advisor Checklist Performance";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Checklist Performance"];
...
const aws_res_aws_trusted_advisor_checklist_performance = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_trusted_advisor_checklist_performance;

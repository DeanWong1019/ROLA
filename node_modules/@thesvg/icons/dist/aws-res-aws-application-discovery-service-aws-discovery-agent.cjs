...
exports.slug = "aws-res-aws-application-discovery-service-aws-discovery-agent";
exports.title = "AWS Application Discovery Service AWS Discovery Agent";
exports.hex = "01A88D";
exports.categories = ["Migration"];
exports.aliases = ["AWS Discovery Agent"];

// @thesvg/icons - Amazon CloudWatch Synthetics
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-synthetics";
export const title = "Amazon CloudWatch Synthetics";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Synthetics"];
...
const aws_res_amazon_cloudwatch_synthetics = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_synthetics;

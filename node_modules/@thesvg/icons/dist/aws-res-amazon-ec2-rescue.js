// @thesvg/icons - Amazon EC2 Rescue
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-ec2-rescue";
export const title = "Amazon EC2 Rescue";
export const hex = "ED7100";
export const categories = ["Compute"];
export const aliases = ["Rescue"];
...
const aws_res_amazon_ec2_rescue = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_ec2_rescue;

// @thesvg/icons - Remotion
// Auto-generated. Do not edit.

export const slug = "remotion";
export const title = "Remotion";
export const hex = "000000";
export const categories = ["Framework", "Software"];
export const aliases = [];
export const svg = `<svg width="250" height="250" viewBox="0 0 250 250" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const url = "https://www.remotion.dev/";

const remotion = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - Amazon Aurora Amazon RDS Instance Aternate
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-aurora-amazon-rds-instance-aternate";
export const title = "Amazon Aurora Amazon RDS Instance Aternate";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Amazon RDS Instance Aternate"];
...
const aws_res_amazon_aurora_amazon_rds_instance_aternate = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_aurora_amazon_rds_instance_aternate;

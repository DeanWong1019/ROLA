// @thesvg/icons - Amazon EMR EMR Engine
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-emr-emr-engine";
export const title = "Amazon EMR EMR Engine";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["EMR Engine"];
...
const aws_res_amazon_emr_emr_engine = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_emr_emr_engine;

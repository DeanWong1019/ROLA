// @thesvg/icons - Amazon DynamoDB Items
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-dynamodb-items";
export const title = "Amazon DynamoDB Items";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Items"];
...
const aws_res_amazon_dynamodb_items = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_dynamodb_items;

...
exports.slug = "aws-res-aws-database-migration-service-database-migration-workflow-or-job";
exports.title = "AWS Database Migration Service Database migration workflow or job";
exports.hex = "527FFF";
exports.categories = ["Database"];
exports.aliases = ["Database migration workflow or job"];

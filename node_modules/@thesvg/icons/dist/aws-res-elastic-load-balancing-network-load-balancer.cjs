...
exports.slug = "aws-res-elastic-load-balancing-network-load-balancer";
exports.title = "Elastic Load Balancing Network Load Balancer";
exports.hex = "8C4FFF";
exports.categories = ["Networking"];
exports.aliases = ["Network Load Balancer"];

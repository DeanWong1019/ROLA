...
exports.slug = "aws-res-amazon-elastic-container-service-copiiot-cli";
exports.title = "Amazon Elastic Container Service CopiIoT CLI";
exports.hex = "ED7100";
exports.categories = ["Containers"];
exports.aliases = ["CopiIoT CLI"];

// @thesvg/icons - Amazon EventBridge Schema
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-eventbridge-schema";
export const title = "Amazon EventBridge Schema";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Schema"];
...
const aws_res_amazon_eventbridge_schema = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_eventbridge_schema;

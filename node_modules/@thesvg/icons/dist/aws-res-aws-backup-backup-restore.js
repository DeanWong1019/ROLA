// @thesvg/icons - AWS Backup Backup Restore
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-backup-restore";
export const title = "AWS Backup Backup Restore";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Backup Restore"];
...
const aws_res_aws_backup_backup_restore = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_backup_restore;

...
exports.slug = "aws-res-amazon-elastic-kubernetes-service-eks-on-outposts";
exports.title = "Amazon Elastic Kubernetes Service EKS on Outposts";
exports.hex = "ED7100";
exports.categories = ["Containers"];
exports.aliases = ["EKS on Outposts"];

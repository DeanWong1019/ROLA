// @thesvg/icons - Proton Mail
// Auto-generated. Do not edit.

export const slug = "proton-mail";
export const title = "Proton Mail";
export const hex = "6D4AFF";
export const categories = ["Software", "Privacy"];
export const aliases = [];
export const svg = `<svg fill="#6D4AFF" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Proton Mail</title><path d="m15.24 8.998 3.656-3.073v15.81H2.482C1.11 21.735 0 20.609 0 19.223V6.944l7.58 6.38a2.186 2.186 0 0 0 2.871-.042l4.792-4.284h-.003zm-5.456 3.538 1.809-1.616a2.438 2.438 0 0 1-1.178-.533L.905 2.395A.552.552 0 0 0 0 2.826v2.811l8.226 6.923a1.186 1.186 0 0 0 1.558-.024zM23.871 2.463a.551.551 0 0 0-.776-.068l-3.199 2.688v16.653h1.623c1.371 0 2.481-1.127 2.481-2.513V2.824a.551.551 0 0 0-.129-.36z"/></svg>`;
export const variants = {
  "default": `<svg fill="#6D4AFF" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Proton Mail</title><path d="m15.24 8.998 3.656-3.073v15.81H2.482C1.11 21.735 0 20.609 0 19.223V6.944l7.58 6.38a2.186 2.186 0 0 0 2.871-.042l4.792-4.284h-.003zm-5.456 3.538 1.809-1.616a2.438 2.438 0 0 1-1.178-.533L.905 2.395A.552.552 0 0 0 0 2.826v2.811l8.226 6.923a1.186 1.186 0 0 0 1.558-.024zM23.871 2.463a.551.551 0 0 0-.776-.068l-3.199 2.688v16.653h1.623c1.371 0 2.481-1.127 2.481-2.513V2.824a.551.551 0 0 0-.129-.36z"/></svg>`,
  "mono": `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Proton Mail</title><path d="m15.24 8.998 3.656-3.073v15.81H2.482C1.11 21.735 0 20.609 0 19.223V6.944l7.58 6.38a2.186 2.186 0 0 0 2.871-.042l4.792-4.284h-.003zm-5.456 3.538 1.809-1.616a2.438 2.438 0 0 1-1.178-.533L.905 2.395A.552.552 0 0 0 0 2.826v2.811l8.226 6.923a1.186 1.186 0 0 0 1.558-.024zM23.871 2.463a.551.551 0 0 0-.776-.068l-3.199 2.688v16.653h1.623c1.371 0 2.481-1.127 2.481-2.513V2.824a.551.551 0 0 0-.129-.36z"/></svg>`,
  "wordmark": `<svg width="4384" height="746" viewBox="0 0 4384 746" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M723.649 140.477V745.457H823.935C876.376 745.457 918.874 702.373 918.874 649.324V21.9482C918.874 3.82252 898.047 -6.04696 884.257 5.5307L723.649 140.477Z" fill="url(#paint0_linear_11862_387834)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M583.774 258.152L400.557 422.042C369.318 449.942 322.693 450.606 290.702 423.655L0.726562 179.575V22.0434C0.726562 3.91773 21.553 -6.04665 35.3435 5.53101L399.15 311.295C434.33 340.903 485.364 340.903 520.544 311.295L583.774 258.152Z" fill="url(#paint1_linear_11862_387834)"/>
<path d="M723.649 140.572L583.774 258.152L583.868 258.151L400.557 422.042C369.318 449.942 322.693 450.606 290.702 423.655L0.726562 179.575V649.324C0.726562 702.373 43.2238 745.457 95.6652 745.457L723.649 745.457V140.572Z" fill="url(#paint2_radial_11862_387834)"/>
</g>
<defs>
...
<radialGradient id="paint2_radial_11862_387834" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(914.874 91.7294) scale(1070.72 1083.11)">
<stop offset="0.5561" stop-color="#6D4AFF"/>
<stop offset="0.9944" stop-color="#AA8EFF"/>
</radialGradient>
<clipPath id="clip0_11862_387834">
<rect width="4383" height="746" fill="white" transform="translate(0.726562)"/>
</clipPath>
</defs>
</svg>`
};
export const license = "CC0-1.0";
export const url = "https://mail.proton.me";

const proton_mail = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default proton_mail;

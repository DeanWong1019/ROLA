...
export const slug = "paypal";
export const title = "PayPal";
...
export const url = "https://paypal.com";

const paypal = { slug, title, hex, categories, aliases, svg, variants, license, url };

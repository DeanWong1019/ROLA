// @thesvg/icons - Amazon File Cache Hybrid NFS linked datasets
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-file-cache-hybrid-nfs-linked-datasets";
export const title = "Amazon File Cache Hybrid NFS linked datasets";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Hybrid NFS linked datasets"];
...
const aws_res_amazon_file_cache_hybrid_nfs_linked_datasets = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_file_cache_hybrid_nfs_linked_datasets;

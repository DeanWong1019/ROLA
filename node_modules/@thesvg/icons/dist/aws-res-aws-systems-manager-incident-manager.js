// @thesvg/icons - AWS Systems Manager Incident Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-incident-manager";
export const title = "AWS Systems Manager Incident Manager";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Incident Manager"];
...
const aws_res_aws_systems_manager_incident_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_incident_manager;

// @thesvg/icons - AWS IoT Device Defender IoT Device Jobs
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-device-defender-iot-device-jobs";
export const title = "AWS IoT Device Defender IoT Device Jobs";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["IoT Device Jobs"];
...
const aws_res_aws_iot_device_defender_iot_device_jobs = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_device_defender_iot_device_jobs;

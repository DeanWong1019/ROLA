...
exports.slug = "aws-res-amazon-elastic-container-service-container-3";
exports.title = "Amazon Elastic Container Service Container 3";
exports.hex = "ED7100";
exports.categories = ["Containers"];
exports.aliases = ["Container 3"];

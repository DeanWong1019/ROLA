// @thesvg/icons - Amazon EventBridge Custom Event Bus
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-eventbridge-custom-event-bus";
export const title = "Amazon EventBridge Custom Event Bus";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Custom Event Bus"];
...
const aws_res_amazon_eventbridge_custom_event_bus = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_eventbridge_custom_event_bus;

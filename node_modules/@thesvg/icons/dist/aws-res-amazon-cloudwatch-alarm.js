// @thesvg/icons - Amazon CloudWatch Alarm
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-alarm";
export const title = "Amazon CloudWatch Alarm";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Alarm"];
...
const aws_res_amazon_cloudwatch_alarm = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_alarm;

// @thesvg/icons - Amazon Elastic Container Service ECS Service Connect
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-elastic-container-service-ecs-service-connect";
export const title = "Amazon Elastic Container Service ECS Service Connect";
export const hex = "ED7100";
export const categories = ["Containers"];
export const aliases = ["ECS Service Connect"];
...
const aws_res_amazon_elastic_container_service_ecs_service_connect = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_elastic_container_service_ecs_service_connect;

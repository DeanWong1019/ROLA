// @thesvg/icons - Amazon EMR HDFS Cluster
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-emr-hdfs-cluster";
export const title = "Amazon EMR HDFS Cluster";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["HDFS Cluster"];
...
const aws_res_amazon_emr_hdfs_cluster = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_emr_hdfs_cluster;

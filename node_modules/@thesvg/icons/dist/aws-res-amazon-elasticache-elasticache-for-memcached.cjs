...
exports.slug = "aws-res-amazon-elasticache-elasticache-for-memcached";
exports.title = "Amazon ElastiCache ElastiCache for Memcached";
exports.hex = "527FFF";
exports.categories = ["Database"];
exports.aliases = ["ElastiCache for Memcached"];

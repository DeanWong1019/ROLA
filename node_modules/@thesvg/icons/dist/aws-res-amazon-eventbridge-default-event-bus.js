// @thesvg/icons - Amazon EventBridge Default Event Bus
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-eventbridge-default-event-bus";
export const title = "Amazon EventBridge Default Event Bus";
export const hex = "E7157B";
export const categories = ["Integration"];
export const aliases = ["Default Event Bus"];
...
const aws_res_amazon_eventbridge_default_event_bus = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_eventbridge_default_event_bus;

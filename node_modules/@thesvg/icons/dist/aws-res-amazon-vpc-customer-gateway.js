// @thesvg/icons - Amazon VPC Customer Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-customer-gateway";
export const title = "Amazon VPC Customer Gateway";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Customer Gateway"];
...
const aws_res_amazon_vpc_customer_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_customer_gateway;

// @thesvg/icons - Amazon SageMaker AI Canvas
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-sagemaker-ai-canvas";
export const title = "Amazon SageMaker AI Canvas";
export const hex = "01A88D";
export const categories = ["AI"];
export const aliases = ["Canvas"];
...
const aws_res_amazon_sagemaker_ai_canvas = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_sagemaker_ai_canvas;

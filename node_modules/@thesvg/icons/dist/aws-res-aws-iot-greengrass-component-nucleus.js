// @thesvg/icons - AWS IoT Greengrass Component Nucleus
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-greengrass-component-nucleus";
export const title = "AWS IoT Greengrass Component Nucleus";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Component Nucleus"];
...
const aws_res_aws_iot_greengrass_component_nucleus = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_greengrass_component_nucleus;

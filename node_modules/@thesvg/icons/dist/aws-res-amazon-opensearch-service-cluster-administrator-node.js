// @thesvg/icons - Amazon OpenSearch Service Cluster Administrator Node
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-opensearch-service-cluster-administrator-node";
export const title = "Amazon OpenSearch Service Cluster Administrator Node";
export const hex = "8C4FFF";
export const categories = ["Analytics"];
export const aliases = ["Cluster Administrator Node"];
...
const aws_res_amazon_opensearch_service_cluster_administrator_node = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_opensearch_service_cluster_administrator_node;

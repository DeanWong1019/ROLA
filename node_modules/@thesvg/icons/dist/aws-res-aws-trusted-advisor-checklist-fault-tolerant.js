// @thesvg/icons - AWS Trusted Advisor Checklist Fault Tolerant
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-trusted-advisor-checklist-fault-tolerant";
export const title = "AWS Trusted Advisor Checklist Fault Tolerant";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Checklist Fault Tolerant"];
...
const aws_res_aws_trusted_advisor_checklist_fault_tolerant = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_trusted_advisor_checklist_fault_tolerant;

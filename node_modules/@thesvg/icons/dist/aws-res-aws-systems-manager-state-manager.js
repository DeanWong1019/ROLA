// @thesvg/icons - AWS Systems Manager State Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-state-manager";
export const title = "AWS Systems Manager State Manager";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["State Manager"];
...
const aws_res_aws_systems_manager_state_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_state_manager;

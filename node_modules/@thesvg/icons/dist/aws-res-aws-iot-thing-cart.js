// @thesvg/icons - AWS IoT Thing_Cart
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-cart";
export const title = "AWS IoT Thing_Cart";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Cart"];
...
const aws_res_aws_iot_thing_cart = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_cart;

// @thesvg/icons - AWS Backup Backup Vault
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-backup-vault";
export const title = "AWS Backup Backup Vault";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Backup Vault"];
...
const aws_res_aws_backup_backup_vault = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_backup_vault;

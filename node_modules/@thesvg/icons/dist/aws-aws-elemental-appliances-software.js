// @thesvg/icons - AWS Elemental Appliances & Software
// Auto-generated. Do not edit.

export const slug = "aws-aws-elemental-appliances-software";
export const title = "AWS Elemental Appliances & Software";
...
<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <title>Icon-Architecture/16/Arch_AWS-Elemental-Appliances-&amp;-Software_16</title>
    <g id="Icon-Architecture/16/Arch_AWS-Elemental-Appliances-&amp;-Software_16" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Icon-Architecture-BG/16/Media-Services" fill="#ED7100">
            <rect id="Rectangle" x="0" y="0" width="24" height="24"></rect>
        </g>
        <path d="M13.276,15.219 L12,15.949 L10.723,15.219 L10.723,13.766 L12,13.036 L13.276,13.766 L13.276,15.219 Z M14.276,13.476 C14.276,13.297 14.18,13.131 14.024,13.042 L12.248,12.026 C12.093,11.938 11.906,11.938 11.752,12.026 L9.975,13.042 C9.819,13.131 9.723,13.297 9.723,13.476 L9.723,14 L5,14 L5,15 L9.723,15 L9.723,15.509 C9.723,15.688 9.819,15.854 9.975,15.943 L11.5,16.816 L11.5,19 L12.5,19 L12.5,16.816 L14.024,15.943 C14.18,15.854 14.276,15.688 14.276,15.509 L14.276,15 L19,15 L19,14 L14.276,14 L14.276,13.476 Z M6,9 L8,9 L8,8 L6,8 L6,9 Z M13,9 L18,9 L18,8 L13,8 L13,9 Z M5,10 L19,10 L19,6 L5,6 L5,10 Z M19.5,5 L4.5,5 C4.223,5 4,5.224 4,5.5 L4,10.5 C4,10.777 4.223,11 4.5,11 L19.5,11 C19.776,11 20,10.777 20,10.5 L20,5.5 C20,5.224 19.776,5 19.5,5 L19.5,5 Z" id="AWS-Elemental-Appliances-&amp;-Software_Icon_16_Squid" fill="#FFFFFF"></path>
    </g>
</svg>`,
  "32": `<?xml version="1.0" encoding="UTF-8"?>
<svg width="40px" height="40px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <title>Icon-Architecture/32/Arch_AWS-Elemental-Appliances-&amp;-Software_32</title>
    <g id="Icon-Architecture/32/Arch_AWS-Elemental-Appliances-&amp;-Software_32" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Icon-Architecture-BG/32/Media-Services" fill="#ED7100">
            <rect id="Rectangle" x="0" y="0" width="40" height="40"></rect>
        </g>
        <path d="M22.941,26.044 L20.5,27.441 L18.058,26.044 L18.058,23.257 L20.5,21.86 L22.941,23.257 L22.941,26.044 Z M23.941,22.967 C23.941,22.788 23.845,22.623 23.689,22.533 L20.748,20.85 C20.595,20.762 20.404,20.762 20.252,20.85 L17.31,22.533 C17.154,22.623 17.058,22.788 17.058,22.967 L17.058,24.046 L8,24.046 L8,25.046 L17.058,25.046 L17.058,26.334 C17.058,26.513 17.154,26.679 17.31,26.768 L20,28.307 L20,31.984 L21,31.984 L21,28.307 L23.689,26.768 C23.845,26.679 23.941,26.513 23.941,26.334 L23.941,25.046 L33,25.046 L33,24.046 L23.941,24.046 L23.941,22.967 Z M10,14 L13,14 L13,13 L10,13 L10,14 Z M23,14 L31,14 L31,13 L23,13 L23,14 Z M8,17 L33,17 L33,9 L8,9 L8,17 Z M33.5,8 L7.5,8 C7.223,8 7,8.223 7,8.5 L7,17.5 C7,17.776 7.223,18 7.5,18 L33.5,18 C33.776,18 34,17.776 34,17.5 L34,8.5 C34,8.223 33.776,8 33.5,8 L33.5,8 Z" id="AWS-Elemental-Appliances-&amp;-Software_Icon_32_Squid" fill="#FFFFFF"></path>
    </g>
</svg>`,
...
export const url = "https://aws.amazon.com/elemental-appliances-software/";

const aws_aws_elemental_appliances_software = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_aws_elemental_appliances_software;

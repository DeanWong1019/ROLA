// @thesvg/icons - AWS Cloud WAN Transit Gateway Route Table Attachment
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-cloud-wan-transit-gateway-route-table-attachment";
export const title = "AWS Cloud WAN Transit Gateway Route Table Attachment";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Transit Gateway Route Table Attachment"];
...
const aws_res_aws_cloud_wan_transit_gateway_route_table_attachment = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_cloud_wan_transit_gateway_route_table_attachment;

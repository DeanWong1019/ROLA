...
export const slug = "matlab";
export const title = "matlab";
...
export const url = "https://www.mathworks.com/products/matlab.html";

const matlab = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - Kolors (快手可图)
// Auto-generated. Do not edit.

export const slug = "kolors";
export const title = "Kolors (快手可图)";
export const hex = "83FF63";
...
export const url = "https://kolors.kuaishou.com";

const kolors = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default kolors;

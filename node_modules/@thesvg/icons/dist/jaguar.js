...
export const slug = "jaguar";
export const title = "Jaguar";
export const hex = "4C4A4D";
export const categories = ["Automotive", "Transportation"];
export const aliases = ["JLR", "Jaguar Cars"];
...
const jaguar = { slug, title, hex, categories, aliases, svg, variants, license, url };

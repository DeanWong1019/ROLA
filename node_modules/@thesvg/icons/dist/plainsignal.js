// @thesvg/icons - PlainSignal
// Auto-generated. Do not edit.

export const slug = "plainsignal";
export const title = "PlainSignal";
export const hex = "000000";
export const categories = ["Analytics", "Software"];
export const aliases = [];
export const svg = `<svg width="64px" height="64px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
export const variants = {
  "default": `<svg width="64px" height="64px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g>
            <rect fill="#FFFFFF" x="0" y="0" width="64" height="64" rx="8"></rect>
            <circle fill="#2463EB" fill-rule="nonzero" cx="32" cy="32" r="24"></circle>
...
export const url = "https://plainsignal.com/";

const plainsignal = { slug, title, hex, categories, aliases, svg, variants, license, url };

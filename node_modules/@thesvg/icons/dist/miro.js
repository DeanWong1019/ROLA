...
export const slug = "miro";
export const title = "Miro";
export const hex = "050038";
export const categories = ["Software", "Platform"];
export const aliases = [];
export const svg = `<svg fill="#050038" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Miro</title><path d="M17.392 0H13.9L17 4.808 10.444 0H6.949l3.102 6.3L3.494 0H0l3.05 8.131L0 24h3.494L10.05 6.985 6.949 24h3.494L17 5.494 13.899 24h3.493L24 3.672 17.392 0z"/></svg>`;
export const variants = {
  "default": `<svg fill="#050038" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Miro</title><path d="M17.392 0H13.9L17 4.808 10.444 0H6.949l3.102 6.3L3.494 0H0l3.05 8.131L0 24h3.494L10.05 6.985 6.949 24h3.494L17 5.494 13.899 24h3.493L24 3.672 17.392 0z"/></svg>`,
  "mono": `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Miro</title><path d="M17.392 0H13.9L17 4.808 10.444 0H6.949l3.102 6.3L3.494 0H0l3.05 8.131L0 24h3.494L10.05 6.985 6.949 24h3.494L17 5.494 13.899 24h3.493L24 3.672 17.392 0z"/></svg>`,
  "dark": `<svg width="400" height="400" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M265.573 77.3491H229.74L259.629 129.85L193.906 77.3491H158.072L190.934 141.468L122.238 77.3491H86.4041L122.238 159.031L86.4041 322.377H122.238L190.934 147.396L158.072 322.377H193.906L259.629 135.693L229.74 322.377H265.573L331.297 118.232L265.573 77.4335V77.3491Z" fill="#1C1C1E"/>
  ...
  "light": `<svg width="400" height="400" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M299.246 2C353.757 2.00019 398 46.2435 398 100.754V298.246C398 352.757 353.757 397 299.246 397H101.754C47.2434 397 3.00017 352.757 3 298.246V100.754C3.00017 46.2603 47.2434 2.00016 101.754 2H299.246ZM122.238 159.03L86.4043 322.377H122.238L190.934 147.396L158.072 322.377H193.905L259.629 135.693L229.739 322.377H265.573L331.297 118.232L265.573 77.4336V77.3486H229.739L259.629 129.851L193.905 77.3486H158.072L190.934 141.469L122.238 77.3486H86.4043L122.238 159.03Z" fill="white"/>
</svg>`,
...
export const url = "https://miro.com";

const miro = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default miro;

// @thesvg/icons - AWS IoT Greengrass Connector
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-greengrass-connector";
export const title = "AWS IoT Greengrass Connector";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Connector"];
...
const aws_res_aws_iot_greengrass_connector = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_greengrass_connector;

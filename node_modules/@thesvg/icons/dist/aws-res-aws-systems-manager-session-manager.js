// @thesvg/icons - AWS Systems Manager Session Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-session-manager";
export const title = "AWS Systems Manager Session Manager";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Session Manager"];
...
const aws_res_aws_systems_manager_session_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_session_manager;

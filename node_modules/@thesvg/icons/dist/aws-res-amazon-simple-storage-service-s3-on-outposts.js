// @thesvg/icons - Amazon Simple Storage Service S3 On Outposts
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-simple-storage-service-s3-on-outposts";
export const title = "Amazon Simple Storage Service S3 On Outposts";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["S3 On Outposts"];
...
const aws_res_amazon_simple_storage_service_s3_on_outposts = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_simple_storage_service_s3_on_outposts;

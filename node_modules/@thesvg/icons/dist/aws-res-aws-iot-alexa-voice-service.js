// @thesvg/icons - AWS IoT Alexa_Voice Service
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-alexa-voice-service";
export const title = "AWS IoT Alexa_Voice Service";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Alexa_Voice Service"];
...
const aws_res_aws_iot_alexa_voice_service = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_alexa_voice_service;

// @thesvg/icons - Technology Innovation Institute (Falcon)
// Auto-generated. Do not edit.

export const slug = "technology-innovation-institute-falcon";
export const title = "Technology Innovation Institute (Falcon)";
export const hex = "6400FF";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>Technology Innovation Institute (Falcon)</title>
...
export const url = "https://tii.ae";

const technology_innovation_institute_falcon = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default technology_innovation_institute_falcon;

...
exports.slug = "aws-res-elastic-load-balancing-classic-load-balancer";
exports.title = "Elastic Load Balancing Classic Load Balancer";
exports.hex = "8C4FFF";
exports.categories = ["Networking"];
exports.aliases = ["Classic Load Balancer"];

// @thesvg/icons - Amazon VPC VPN Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-vpn-gateway";
export const title = "Amazon VPC VPN Gateway";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["VPN Gateway"];
...
const aws_res_amazon_vpc_vpn_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_vpn_gateway;

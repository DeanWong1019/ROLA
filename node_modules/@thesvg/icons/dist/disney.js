...
export const slug = "disney";
export const title = "Disney";
export const hex = "113CCF";
export const categories = ["Entertainment", "Platform"];
export const aliases = ["Walt Disney", "The Walt Disney Company"];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="700"  height="294.4" viewBox="0 0 700.00001 294.42258">

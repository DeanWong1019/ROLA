// @thesvg/icons - HuaweiCloud (华为云)
// Auto-generated. Do not edit.

export const slug = "huaweicloud";
export const title = "HuaweiCloud (华为云)";
export const hex = "C7000B";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>HuaweiCloud (华为云)</title>
...
export const url = "https://huaweicloud.com";

const huaweicloud = { slug, title, hex, categories, aliases, svg, variants, license, url };

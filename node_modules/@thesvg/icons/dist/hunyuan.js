// @thesvg/icons - Hunyuan (腾讯混元)
// Auto-generated. Do not edit.

export const slug = "hunyuan";
export const title = "Hunyuan (腾讯混元)";
export const hex = "0053e0";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>Hunyuan (腾讯混元)</title>
...
export const url = "https://hunyuan.tencent.com";

const hunyuan = { slug, title, hex, categories, aliases, svg, variants, license, url };

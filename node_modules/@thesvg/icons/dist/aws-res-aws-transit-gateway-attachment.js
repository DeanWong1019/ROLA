// @thesvg/icons - AWS Transit Gateway Attachment
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-transit-gateway-attachment";
export const title = "AWS Transit Gateway Attachment";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Attachment"];
...
const aws_res_aws_transit_gateway_attachment = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_transit_gateway_attachment;

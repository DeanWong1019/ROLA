// @thesvg/icons - AWS Storage Gateway Amazon FSx File Gateway
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-storage-gateway-amazon-fsx-file-gateway";
export const title = "AWS Storage Gateway Amazon FSx File Gateway";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Amazon FSx File Gateway"];
...
const aws_res_aws_storage_gateway_amazon_fsx_file_gateway = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_storage_gateway_amazon_fsx_file_gateway;

// @thesvg/icons - Amazon Route 53 Resolver
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-route-53-resolver";
export const title = "Amazon Route 53 Resolver";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Resolver"];
...
const aws_res_amazon_route_53_resolver = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_route_53_resolver;

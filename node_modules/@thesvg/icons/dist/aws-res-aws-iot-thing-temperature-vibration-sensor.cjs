...
exports.slug = "aws-res-aws-iot-thing-temperature-vibration-sensor";
exports.title = "AWS IoT Thing_Temperature Vibration Sensor";
exports.hex = "232F3E";
exports.categories = ["IoT"];
exports.aliases = ["Thing_Temperature Vibration Sensor"];

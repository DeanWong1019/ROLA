...
exports.slug = "aws-res-amazon-dynamodb-standard-infrequent-access-table-class";
exports.title = "Amazon DynamoDB Standard Infrequent Access Table Class";
exports.hex = "527FFF";
exports.categories = ["Database"];
exports.aliases = ["Standard Infrequent Access Table Class"];

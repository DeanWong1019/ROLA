// @thesvg/icons - Amazon Route 53 Resolver DNS Firewall
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-route-53-resolver-dns-firewall";
export const title = "Amazon Route 53 Resolver DNS Firewall";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Resolver DNS Firewall"];
...
const aws_res_amazon_route_53_resolver_dns_firewall = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_route_53_resolver_dns_firewall;

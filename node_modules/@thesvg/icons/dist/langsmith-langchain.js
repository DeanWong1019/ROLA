// @thesvg/icons - LangSmith (LangChain)
// Auto-generated. Do not edit.

export const slug = "langsmith-langchain";
export const title = "LangSmith (LangChain)";
...
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <title>LangSmith (LangChain)</title>
...
export const url = "https://langchain.com/langsmith";

const langsmith_langchain = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default langsmith_langchain;

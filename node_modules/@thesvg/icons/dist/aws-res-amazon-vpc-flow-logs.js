// @thesvg/icons - Amazon VPC Flow Logs
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-flow-logs";
export const title = "Amazon VPC Flow Logs";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Flow Logs"];
...
const aws_res_amazon_vpc_flow_logs = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_flow_logs;

// @thesvg/icons - Audition
// Auto-generated. Do not edit.

export const slug = "audition";
export const title = "Audition";
export const hex = "00005B";
export const categories = ["Design", "Music", "Software"];
...
export const url = "https://www.adobe.com/products/audition";

const audition = { slug, title, hex, categories, aliases, svg, variants, license, url };

// @thesvg/icons - AWS Backup Audit Manager
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-audit-manager";
export const title = "AWS Backup Audit Manager";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Audit Manager"];
...
const aws_res_aws_backup_audit_manager = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_audit_manager;

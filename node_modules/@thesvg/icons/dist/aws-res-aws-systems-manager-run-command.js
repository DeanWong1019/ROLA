// @thesvg/icons - AWS Systems Manager Run Command
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-systems-manager-run-command";
export const title = "AWS Systems Manager Run Command";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Run Command"];
...
const aws_res_aws_systems_manager_run_command = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_systems_manager_run_command;

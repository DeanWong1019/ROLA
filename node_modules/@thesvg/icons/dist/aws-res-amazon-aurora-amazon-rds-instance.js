// @thesvg/icons - Amazon Aurora Amazon RDS Instance
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-aurora-amazon-rds-instance";
export const title = "Amazon Aurora Amazon RDS Instance";
export const hex = "527FFF";
export const categories = ["Database"];
export const aliases = ["Amazon RDS Instance"];
...
const aws_res_amazon_aurora_amazon_rds_instance = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_aurora_amazon_rds_instance;

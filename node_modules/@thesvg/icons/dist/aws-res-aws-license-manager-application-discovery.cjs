...
exports.slug = "aws-res-aws-license-manager-application-discovery";
exports.title = "AWS License Manager Application Discovery";
exports.hex = "232F3E";
exports.categories = ["Management Governance"];
exports.aliases = ["Application Discovery"];

// @thesvg/icons - Postmark
// Auto-generated. Do not edit.

export const slug = "postmark";
export const title = "Postmark";
export const hex = "FFDE00";
export const categories = ["SaaS", "Devtool"];
export const aliases = ["Postmark App"];
export const svg = `<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const url = "https://postmarkapp.com";

const postmark = { slug, title, hex, categories, aliases, svg, variants, license, url };

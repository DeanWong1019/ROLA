// @thesvg/icons - Amazon CloudWatch Cross account Observability
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-cloudwatch-cross-account-observability";
export const title = "Amazon CloudWatch Cross account Observability";
export const hex = "232F3E";
export const categories = ["Management Governance"];
export const aliases = ["Cross account Observability"];
...
const aws_res_amazon_cloudwatch_cross_account_observability = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_cloudwatch_cross_account_observability;

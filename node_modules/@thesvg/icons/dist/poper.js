...
export const slug = "poper";
export const title = "Poper";
export const hex = "000000";
export const categories = ["AI", "Software"];
export const aliases = [];
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="1200" fill="none" viewBox="0 0 1200 1200">
  ...
  <g mask="url(#poper-favicon__a)">
    <path stroke="currentColor" stroke-width="2.534" d="M635.473 1187.57s-24.685-29.53-24.685-85.37h-21.356c0 55.84-24.698 85.37-24.698 85.37"/>
  </g>
  ...
  <mask id="poper-favicon__b" width="893" height="1143" x="154" y="0" maskUnits="userSpaceOnUse" style="mask-type:luminance">
    <path fill="#fff" d="M154 0h892.97v1142.35H154V0Z"/>
  </mask>
  <g mask="url(#poper-favicon__b)">
    <path stroke="currentColor" stroke-width="2.534" d="M1042.99 478.459c0 332.077-250.978 624.441-442.853 624.441-184.512 0-442.863-265.667-442.863-624.441-.013-262.34 180.315-475.027 442.863-475.027 262.52 0 442.853 212.674 442.853 475.027Z"/>
  </g>
  <mask id="poper-favicon__c" width="73" height="24" x="564" y="1176" maskUnits="userSpaceOnUse" style="mask-type:luminance">
...
export const variants = {
  "default": `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="1200" fill="none" viewBox="0 0 1200 1200">
  <path fill="#F14A16" d="M635.473 1187.57s-24.685-29.53-24.685-85.37h-21.356c0 55.84-24.698 85.37-24.698 85.37"/>
  <mask id="poper-favicon__a" width="148" height="137" x="526" y="1063" maskUnits="userSpaceOnUse" style="mask-type:luminance">
    <path fill="#fff" d="M526.618 1063.72h147.118V1200H526.618v-136.28Z"/>
  </mask>
...
export const url = "https://www.poper.ai";

const poper = { slug, title, hex, categories, aliases, svg, variants, license, url };

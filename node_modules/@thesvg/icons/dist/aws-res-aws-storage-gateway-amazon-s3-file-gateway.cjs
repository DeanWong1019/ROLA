...
exports.slug = "aws-res-aws-storage-gateway-amazon-s3-file-gateway";
exports.title = "AWS Storage Gateway Amazon S3 File Gateway";
exports.hex = "3F8624";
exports.categories = ["Storage"];
exports.aliases = ["Amazon S3 File Gateway"];

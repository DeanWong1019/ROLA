// @thesvg/icons - AWS Transfer Family AWS FTP
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-transfer-family-aws-ftp";
export const title = "AWS Transfer Family AWS FTP";
export const hex = "01A88D";
export const categories = ["Migration"];
export const aliases = ["AWS FTP"];
...
const aws_res_aws_transfer_family_aws_ftp = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_transfer_family_aws_ftp;

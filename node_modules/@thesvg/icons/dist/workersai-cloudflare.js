// @thesvg/icons - WorkersAI (Cloudflare)
// Auto-generated. Do not edit.

export const slug = "workersai-cloudflare";
export const title = "WorkersAI (Cloudflare)";
...
export const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd">
  <title>WorkersAI (Cloudflare)</title>
...
export const url = "https://developers.cloudflare.com/workers-ai";

const workersai_cloudflare = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default workersai_cloudflare;

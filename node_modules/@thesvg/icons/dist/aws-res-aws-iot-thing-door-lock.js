// @thesvg/icons - AWS IoT Thing_Door Lock
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-iot-thing-door-lock";
export const title = "AWS IoT Thing_Door Lock";
export const hex = "232F3E";
export const categories = ["IoT"];
export const aliases = ["Thing_Door Lock"];
...
const aws_res_aws_iot_thing_door_lock = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_iot_thing_door_lock;

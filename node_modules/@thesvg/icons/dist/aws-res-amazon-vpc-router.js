// @thesvg/icons - Amazon VPC Router
// Auto-generated. Do not edit.

export const slug = "aws-res-amazon-vpc-router";
export const title = "Amazon VPC Router";
export const hex = "8C4FFF";
export const categories = ["Networking"];
export const aliases = ["Router"];
...
const aws_res_amazon_vpc_router = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_amazon_vpc_router;

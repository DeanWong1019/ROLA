// @thesvg/icons - AWS Backup Recovery Time Objective
// Auto-generated. Do not edit.

export const slug = "aws-res-aws-backup-recovery-time-objective";
export const title = "AWS Backup Recovery Time Objective";
export const hex = "3F8624";
export const categories = ["Storage"];
export const aliases = ["Recovery Time Objective"];
...
const aws_res_aws_backup_recovery_time_objective = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default aws_res_aws_backup_recovery_time_objective;

...
exports.slug = "aws-res-amazon-elastic-container-service-ecs-service-connect";
exports.title = "Amazon Elastic Container Service ECS Service Connect";
exports.hex = "ED7100";
exports.categories = ["Containers"];
exports.aliases = ["ECS Service Connect"];

...
export const slug = "usps";
export const title = "USPS";
export const hex = "333366";
export const categories = ["Software", "Platform"];
export const aliases = [];
export const svg = `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 390 47" style="enable-background:new 0 0 390 47;" xml:space="preserve">
 <style type="text/css">
  .st0{fill:#FFFFFF;}
	.st1{fill:#333366;}
...
export const variants = {
  "default": `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 390 47" style="enable-background:new 0 0 390 47;" xml:space="preserve">
 <style type="text/css">
  .st0{fill:#FFFFFF;}
	.st1{fill:#333366;}
	.st2{fill-rule:evenodd;clip-rule:evenodd;fill:#333366;}
 ...
 <path class="st1" d="M380,7.5c0-2.6,2-4.6,4.5-4.6c2.5,0,4.5,2,4.5,4.6c0,2.7-2,4.7-4.5,4.7C381.9,12.2,380,10.2,380,7.5 M379,7.5
  ...
  "mono": `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 76.3 47.2" style="enable-background:new 0 0 76.3 47.2;" xml:space="preserve">
 <style type="text/css">
  .st0{fill:#FFFFFF;}
	.st1{fill:#333366;}
 </style>
 <g>
  ...
  <path class="st1" d="M49.3,9.9c7.7,1.8,7.9,3.7,7.9,3.7c5,0,6.3,0,7.2,0.9c2.9,2.7-2,9.3-2,9.3c-0.6,0.4-55.8,22-55.8,22h58.1
		L74,1.9H11.6C11.6,1.9,48.4,9.7,49.3,9.9">
  </path>
  <path class="st1" d="M55,16.3c-0.8,0.4-3.2,0.8-4,0.9s-1.2,0.1-1.2,0.3c0,0.3,1.1,0.2,1.5,0.2c1.8,0,8.9-0.5,10.6-0.2
		c1.3,0.2-0.2,2.8-0.6,4.4c-0.1,0.6,0.3,0.3,0.5,0c0.5-0.8,1.9-3.4,2-4.4c0.2-2-1.2-2.3-3.6-2.3h-3.7c-0.3,0-0.4,0.1-0.5,0.3
		C55.7,15.8,55.2,16.1,55,16.3">
  </path>
  <path class="st1" d="M32,31.1L2.3,45.8l7.2-33.7l0,0h30c0.5,0,16.1,0,16.4,3.1h-27L33.1,28c4.8-2.3,16.6-7.1,23.7-7.4
		c3-0.1,4.2,0.4,3.6,0.8c-0.4,0.2-3.3,0.6-5.6,1.2c-4,1-4.2,1-8.4,2.4C41.7,26.6,37.8,28.4,32,31.1">
  </path>
 </g>
</svg>`
...
export const url = "https://www.usps.com";

const usps = { slug, title, hex, categories, aliases, svg, variants, license, url };
export default usps;

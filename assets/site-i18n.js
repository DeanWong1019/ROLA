(function(){
  var zh = {
    ...
    'FAQ':'常见问题',
    'FAQs':'常见问题',
    'Answers to your questions':'常见问题解答',
    ...
    'Read article':'阅读文章',
    'How we built a proxy rotator that handles 10M requests daily':'我们如何构建每天处理 1000 万次请求的代理轮换器',
    'How to prevent IP blocks with intelligent proxy rotation':'如何通过智能代理轮换防止 IP 被封',
    'Introducing real-time proxy health monitoring dashboards':'实时代理健康监控仪表板功能介绍',
    'How a retail analytics firm scaled data collection by 300%':'一家零售分析公司如何将数据采集规模提升 300%',
    ...
    'Designing a global proxy network: architecture lessons':'设计全球代理网络：架构经验分享',
    ...
    'FAQ sections':'FAQ 分类',
    'Proxy Basics':'代理基础',
    'Coverage & Targeting':'覆盖与定向',
    'Sessions & Performance':'会话与性能',
    'Integration':'集成使用',
    'Pricing & Trial':'价格与试用',
    'Compliance & Restrictions':'合规与限制',
...
'Supported Countries':'覆盖国家',
    ...
    'End-to-end proxy and data collection solutions for different business scenarios, covering anonymous access, anti-bot unlocking, structured extraction, and ready-to-use datasets.':'针对不同业务场景的端到端代理与数据采集方案，覆盖匿名访问、反爬解锁、结构化抽取及即用数据集。',
    'Static Residential / ISP Proxies':'静态住宅 / ISP 代理',
    'Blend datacenter-level stability with residential IP trust for account access, price monitoring, ad verification, and other workflows that need persistent sessions.':'融合数据中心级稳定性与住宅 IP 信任度，适合账号登录、价格监控、广告验证等需要长期会话的业务。支持固定 IP、长连接、地域定向与高并发访问，降低异常验证与封禁风险。',
    'Sticky IPs and long-lived sessions':'固定 IP 与长会话保持',
    'Residential-grade reputation with ISP stability':'住宅级信誉叠加 ISP 稳定性',
    'Country, city, and carrier targeting':'支持国家、城市与运营商定向',
    'Lower risk of abnormal verification and bans':'降低异常验证与封禁风险',
    'ISP':'ISP',
    'Datacenter':'数据中心',
    'Asia':'亚洲',
    'Rotating Residential Proxy Network':'轮换住宅代理网络',
    'Rotate through real residential IP pools by request or session for large-scale scraping, market research, SEO monitoring, and cross-region access.':'通过真实住宅 IP 池按请求或会话自动轮换，适合大规模抓取、市场调研、SEO 监测和跨地区访问。可按国家、城市、运营商等维度调度节点，在规模化采集时保持更自然的访问画像。',
    'Automatic rotation by request or session':'按请求或会话自动轮换',
    'Real residential IPs for natural access patterns':'真实住宅 IP，访问画像更自然',
    'Precise geo-targeting across regions':'跨国家与地区的精准定位',
    'Built for high-volume collection workflows':'适合高并发、大规模采集任务',
    'Google':'Google',
    'Amazon':'Amazon',
    'Cloudflare':'Cloudflare',
    'Anti-bot Unlocking & Scraping APIs':'反爬解锁与采集 API',
    'Handle proxy rotation, browser fingerprints, CAPTCHA challenges, retries, and extraction behind one API so teams can retrieve stable HTML or structured results.':'面向高防护目标站点提供端到端解锁能力，自动处理代理轮换、浏览器指纹、验证码与请求重试。开发者只需调用统一接口，即可获得稳定 HTML 或结构化结果，减少自建反爬基础设施成本。',
    'Automatic anti-bot and CAPTCHA handling':'自动规避反爬措施与 CAPTCHA',
    'Advanced JS rendering and remote browsers':'高级 JS 渲染与远程浏览器',
    'High-performance requests with near-zero downtime':'高性能请求，近乎零停机',
    'Less infrastructure to build and maintain':'最大限度减少搭建与维护工作',
    'E-commerce':'电商',
    'Social Media':'社交媒体',
    'News':'新闻',
    'Ready-to-use Datasets & Managed Delivery':'即用数据集与托管交付',
    'Deliver cleaned datasets or custom recurring data pipelines for e-commerce, search, jobs, maps, company directories, market analysis, and AI training.':'针对电商、搜索、招聘、地图、企业名录等场景交付清洗后的数据集，也可按业务规则定制采集频率、字段结构和交付格式。从一次性数据采购到持续数据管道，帮助团队更快进入分析和 AI 训练阶段。',
    'Cleaned data ready for analysis and AI training':'清洗后的数据可直接分析与训练 AI',
    'Custom fields, formats, and refresh frequency':'字段、格式与更新频率均可定制',
    'One-time datasets or recurring data pipelines':'支持一次性数据集或持续数据管道',
    'Managed delivery without crawler operations':'托管交付，无需运维爬虫系统',
    'B2B':'B2B',
    'Consumer':'消费者',
    'Web':'Web',
    'Coverage':'覆盖地区',
    ...
    'Integrating our products into your scraping infrastructure is effortless, with multi-language support and ready-to-use code examples for a quick start.':'将产品接入你的爬虫基础设施毫不费力，多语言支持与即用代码示例，助你快速上手。',
    'Rola Documentation':'Rola 文档',
    ...
    'From e-commerce and social platforms to AI and data collection, Rola delivers reliable proxy and data capabilities for the workflows that keep your business moving.':'从电商、社交平台到 AI 与数据采集，Rola 为关键业务流程提供稳定的代理与数据能力，帮助团队持续高效运转。',
    'Social Network':'社交网络',
    'Advertising':'广告',
    'AI':'AI',
    'Web scraping':'网页抓取',

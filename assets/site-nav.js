(function(){
  ...
  var desktopLinks = [
    {key:'proxies', label:'Proxies', href:'index.html'},
  ...
  function mobileLinksFor(active){
    ...
    return [
      {key:'home', label:active === 'pricing' || active === 'use-cases' ? 'Home' : 'Proxies', href:'index.html'},
      {key:'features', label:'Features', href:'index.html#features'},
      {key:'pricing', label:'Pricing', href:'pricing.html'},
      {key:'use-cases', label:'Use Cases', href:'use-case.html'},
      {key:'blog', label:'Blog', href:'blog.html'},
      {key:'faq', label:'FAQs', href:'faq.html'},
      {key:'docs', label:'Docs', href:'index.html#integration'}
    ];
  }
